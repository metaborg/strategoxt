...
public class SSL_EXT_java_call extends AbstractPrimitive {
	...
	@Override
	public boolean call(IContext env, org.spoofax.interpreter.stratego.Strategy[] svars, IStrategoTerm[] tvars) throws InterpreterException {

		if (!isTermString(tvars[0]))
			return false;
		if (!isTermInt(tvars[2]))
			return false;
	...
	protected static Strategy getStrategy(Context context, String className) {
