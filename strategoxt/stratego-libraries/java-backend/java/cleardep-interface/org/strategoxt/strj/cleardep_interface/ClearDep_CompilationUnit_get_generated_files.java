...
public class ClearDep_CompilationUnit_get_generated_files extends AbstractPrimitive {

	public ClearDep_CompilationUnit_get_generated_files() {
		super("ClearDep_CompilationUnit_get_generated_files", 0, 0);
	}
	...
	public boolean call(IContext arg0, Strategy[] arg1, IStrategoTerm[] arg2) throws InterpreterException {
		...
		for(Path p : unit.get().getGeneratedFiles()) {
