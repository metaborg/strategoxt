...
public class ClearDep_CompilationUnit_get_module_deps extends AbstractPrimitive {

	public ClearDep_CompilationUnit_get_module_deps() {
		super("ClearDep_CompilationUnit_get_module_deps", 0, 0);
	}
	...
	public boolean call(IContext arg0, Strategy[] arg1, IStrategoTerm[] arg2) throws InterpreterException {
		try {
			...
			for (CompilationUnit unit : container.getUnit().getModuleDependencies()) {
