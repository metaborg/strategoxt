...
public class ClearDep_CompilationUnit_is_consistent_shallow extends AbstractPrimitive {
	...
	public ClearDep_CompilationUnit_is_consistent_shallow() {
		super("ClearDep_CompilationUnit_is_consistent_shallow", 0, 0);
	}
	...
	public boolean call(IContext arg0, Strategy[] arg1, IStrategoTerm[] arg2) throws InterpreterException {
		...
		try {
			...
			boolean isConsitent = unitContainer.getUnit().isConsistentShallow(editedSourceFiles, mode);
			if (isConsitent) {
