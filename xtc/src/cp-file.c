              ...
              t_19 = t;
              {
                t = not_null(g_19);
                {
                  ...
                  t = o_48(t);
                  {
                    ...
                    {
                      ATerm y_19 = NULL;
                      t = SSLsetAnnotations((ATerm)ATinsert(CheckATermList(not_null(v_19)), not_null(t_19)), not_null(k_19));
                      {
                        y_19 = t;
