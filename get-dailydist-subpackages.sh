...
function asc_support() {
  pkg="asc-support" version="1.8" $@
}
function asf_support() {
  pkg="asf-support" version="1.2" $@
}
function sdf_support() {
  pkg="sdf-support" version="2.0" $@
}
function pt_support() {
...
function pgen() {
  pkg="pgen" version="2.0" $@
}
function error_support() {
  pkg="error-support" version="0.1" $@
}
