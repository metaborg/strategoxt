...
public class InteropRegisterer extends JavaInteropRegisterer {
	public InteropRegisterer() {
		super(new Strategy[] { task_api_add_dependency_0_2.instance, task_api_add_message_0_2.instance,
			task_api_add_read_0_2.instance, task_api_add_task_0_3.instance, task_api_becomes_cyclic_0_2.instance,
			task_api_evaluate_2_1.instance, task_api_exists_0_1.instance, task_api_get_dependencies_0_1.instance,
