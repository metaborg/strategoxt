...
public class task_api_get_dependencies_0_1 extends Strategy {
	...
	public IStrategoTerm invoke(Context context, IStrategoTerm current, IStrategoTerm taskID) {
		return context.getFactory().makeList(TaskManager.getInstance().getCurrent().getDependencies(taskID));
	}
}
