...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_v_35));
  term_v_35 = (ATerm) ATmakeAppl(ATmakeSymbol("Box.pp.af", 0, ATtrue));
  ATprotect(&(term_w_35));
  term_w_35 = (ATerm) ATmakeAppl(ATmakeSymbol("-p", 0, ATtrue));
}
...
ATerm io_pp_box_0 (ATerm t)
{
  ATerm c_7 (ATerm t)
  {
    ...
    ATerm e_7 (ATerm t)
    {
      ...
      t = (ATerm) ATinsert(ATinsert(ATempty, not_null(n_52)), term_w_35);
      return(t);
    }
