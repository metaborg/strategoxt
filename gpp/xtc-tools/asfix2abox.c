...
static void init_module_constant_terms (void)
{
  ...
  ATprotect(&(term_g_11));
  term_g_11 = (ATerm) ATmakeAppl(ATmakeSymbol("** INFO: Using existing parsed pretty print-table: ", 0, ATtrue));
  ATprotect(&(term_h_11));
  ...
  ATprotect(&(term_l_33));
  term_l_33 = (ATerm) ATmakeAppl(sym__2, term_z_29, term_a_30);
  ATprotect(&(term_u_33));
  ...
  ATprotect(&(term_z_34));
  term_z_34 = (ATerm) ATmakeAppl(sym__2, term_b_33, term_a_10);
  ATprotect(&(term_b_35));
  ...
  ATprotect(&(term_e_37));
  term_e_37 = (ATerm) ATmakeAppl(ATmakeSymbol("-b", 0, ATtrue));
  ATprotect(&(term_g_37));
  term_g_37 = (ATerm) ATmakeAppl(sym__2, term_e_37, term_a_10);
  ATprotect(&(term_q_37));
  term_q_37 = (ATerm) ATmakeAppl(sym_Binary_0);
  ATprotect(&(term_r_37));
  term_r_37 = (ATerm) ATmakeAppl(ATmakeSymbol("-b               Write binary output", 0, ATtrue));
  ATprotect(&(term_s_37));
  term_s_37 = (ATerm) ATmakeAppl(sym_None_0);
  ATprotect(&(term_t_37));
  term_t_37 = (ATerm) ATmakeAppl(sym__2, term_y_9, term_s_37);
  ATprotect(&(term_u_37));
  term_u_37 = (ATerm) ATmakeAppl(ATmakeSymbol("-c          Conservative pretty-printing (only format where needed).", 0, ATtrue));
}
...
static ATerm s_6 (ATerm m_14, ATerm l_14, ATerm t);
...
static ATerm u_6 (ATerm i_33, ATerm j_33, ATerm t);
ATerm pass_verbose_0_0 (ATerm t);
ATerm build_impl_args_0_0 (ATerm t);
ATerm read_from_0_0 (ATerm t);
static ATerm v_6 (ATerm n_17, ATerm o_17, ATerm t);
static ATerm w_6 (ATerm z_64 (ATerm), ATerm f_167, ATerm v_17, ATerm t);
...
static ATerm a_7 (ATerm w_73 (ATerm), ATerm x_73 (ATerm), ATerm q_24, ATerm p_24, ATerm t);
static ATerm b_7 (ATerm t_73 (ATerm), ATerm m_24, ATerm l_24, ATerm t);
static ATerm z_1 (ATerm t);
static ATerm c_7 (ATerm e_36, ATerm f_36, ATerm g_36, ATerm t);
static ATerm d_7 (ATerm a_81 (ATerm), ATerm o_36, ATerm n_36, ATerm t);
static ATerm h_7 (ATerm p_38, ATerm q_38, ATerm t);
static ATerm d_13 (ATerm s_12, ATerm t);
ATerm fclose_0_0 (ATerm t);
static ATerm e_7 (ATerm t_17, ATerm t);
static ATerm f_7 (ATerm y_38, ATerm z_38, ATerm t);
...
static ATerm i_7 (ATerm p_79 (ATerm), ATerm q_34, ATerm o_34, ATerm t);
ATerm P__tmpdir_0_0 (ATerm t);
static ATerm g_4 (ATerm t);
ATerm xtc_new_file_0_0 (ATerm t);
ATerm xtc_transform_file_2_0 (ATerm p_0 (ATerm), ATerm r_0 (ATerm), ATerm t);
static ATerm j_7 (ATerm n_14, ATerm o_14, ATerm t);
ATerm copy_to_1_0 (ATerm o_0 (ATerm), ATerm t);
static ATerm k_7 (ATerm m_35, ATerm n_35, ATerm t);
...
static ATerm t_7 (ATerm h_37, ATerm i_37, ATerm t);
...
static ATerm l_7 (ATerm n_37, ATerm m_37, ATerm t);
static ATerm r_7 (ATerm h_35, ATerm i_35, ATerm g_35, ATerm t);
...
static ATerm m_7 (ATerm c_33, ATerm d_33, ATerm t);
...
static ATerm p_7 (ATerm x_31, ATerm y_31, ATerm t);
    ...
    if((PushChoice() == 0))
      {
        ...
        t = get_config_0_0(t);
        j_2 = t;
        t = (ATerm) ATmakeAppl(sym__2, j_2, term_c_11);
        t = geq_0_0(t);
        t = e_2;
        t = u_80(t);
        LocalPopChoice(a_11);
...
ATerm lookup_pp_af_0_0 (ATerm t)
{
  ATerm l_2 = NULL,m_2 = NULL,o_2 = NULL,c_3 = NULL,d_3 = NULL,f_3 = NULL,g_3 = NULL,h_3 = NULL,i_3 = NULL,j_3 = NULL,k_3 = NULL,f_1 = NULL;
  m_2 = t;
  ...
  t = (ATerm) ATinsert(ATempty, term_i_10);
  d_3 = t;
  t = (ATerm) ATmakeAppl(sym__2, f_3, (ATerm) ATinsert(ATempty, term_i_10));
  t = h_7(f_3, d_3, t);
  l_2 = t;
  ...
  static ATerm e_4 (ATerm t)
  {
    ...
    if((PushChoice() == 0))
    ...
    else
      {
        t = s_11;
        {
          ATerm a_4 = NULL,c_4 = NULL,d_4 = NULL,a_2 = NULL,f_2 = NULL,h_1 = NULL;
          a_4 = t;
          ...
          t = e_4(t);
          f_2 = t;
          t = (ATerm) ATinsert(CheckATermList(f_2), c_4);
          h_1 = t;
        ...
        if((PushChoice() == 0))
        ...
        else
          {
            t = y_11;
            {
              ...
              t = term_d_12;
              o_4 = t;
              t = (ATerm) ATinsert(ATinsert(ATempty, m_4), term_g_12);
              p_4 = t;
...
static ATerm g_1 (ATerm t)
{
  ...
  q_4 = t;
  t = (ATerm) ATinsert(ATinsert(ATempty, q_4), term_n_12);
  return(t);
}
static ATerm i_1 (ATerm t)
{
...
ATerm pass_verbose_0_0 (ATerm t)
{
  ATerm r_4 = NULL,s_4 = NULL,t_4 = NULL,w_4 = NULL;
  t = term_b_11;
  {
    ATerm u_12 = t;
    int v_12 = stack_ptr;
  ...
  t = term_h_12;
  w_4 = t;
  t = (ATerm) ATmakeAppl(sym__2, s_4, term_h_12);
  t = u_6(s_4, w_4, t);
  t_4 = t;
  t = SSL_int_to_string(t_4);
  r_4 = t;
  t = (ATerm) ATinsert(ATinsert(ATempty, r_4), term_b_11);
  return(t);
}
ATerm build_impl_args_0_0 (ATerm t)
{
  ...
  a_5 = t;
  t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, a_5), z_4), y_4);
  t = concat_0_0(t);
  return(t);
}
ATerm read_from_0_0 (ATerm t)
{
  ...
  if(match_cons(t, sym_stdin_0))
  ...
  else
    {
      ...
      t = (ATerm) ATinsert(ATempty, term_i_10);
      k_5 = t;
      t = (ATerm) ATmakeAppl(sym__2, h_5, (ATerm) ATinsert(ATempty, term_i_10));
      t = h_7(h_5, k_5, t);
      t = ReadFromFile_0_0(t);
    }
  return(t);
...
{
  ATerm m_5 = NULL;
  t = (ATerm) ATmakeAppl(sym__2, f_167, term_x_12);
  t = g_7(t);
  m_5 = t;
  t = (ATerm) ATmakeAppl(sym__2, m_5, v_17);
  t = z_64(t);
  t = fclose_0_0(t);
  t = v_17;
  return(t);
...
ATerm signal_to_descr_0_0 (ATerm t)
{
  ATerm u_7 = NULL,w_7 = NULL,x_7 = NULL,z_7 = NULL;
  u_7 = t;
  if(match_cons(t, sym_UnknownSignal_1))
  ...
  else
    {
      ...
      h_4 = t;
      t = (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATinsert(ATempty, z_7), term_l_13), h_4), term_k_13), w_7);
      j_4 = t;
...
ATerm signal_from_number_0_0 (ATerm t)
{
  ...
  e_8 = t;
  {
    ...
    if((PushChoice() == 0))
      ...
      {
        t = m_13;
        t = (ATerm) ATmakeAppl(sym_UnknownSignal_1, e_8);
      }
  }
  return(t);
}
    ...
    if((PushChoice() == 0))
      {
        ...
        LocalPopChoice(u_21);
        {
          ...
          if((PushChoice() == 0))
            {
              ATerm f_5 = NULL,i_5 = NULL,o_5 = NULL;
              t = y_8;
              {
                ATerm e_22 = t;
                if((PushChoice() == 0))
              ...
              t = term_d_12;
              i_5 = t;
              t = (ATerm) ATinsert(ATinsert(ATempty, f_5), term_f_22);
              o_5 = t;
              t = SSL_printnl(i_5, o_5);
              t = (ATerm) ATmakeAppl(sym__2, term_d_12, (ATerm) ATinsert(ATinsert(ATempty, f_5), term_f_22));
              LocalPopChoice(d_22);
            }
          else
            {
    ...
    if((PushChoice() == 0))
      {
        ...
        t = get_config_0_0(t);
        r_9 = t;
        t = (ATerm) ATmakeAppl(sym__2, r_9, term_y_20);
        t = geq_0_0(t);
        t = p_9;
        t = x_80(t);
        LocalPopChoice(z_22);
    ...
    if((PushChoice() == 0))
      {
        ...
        t = get_config_0_0(t);
        b_10 = t;
        t = (ATerm) ATmakeAppl(sym__2, b_10, term_b_18);
        t = geq_0_0(t);
        t = v_9;
        t = w_80(t);
        LocalPopChoice(d_23);
    ...
    if((PushChoice() == 0))
      {
        ...
        t = get_config_0_0(t);
        j_10 = t;
        t = (ATerm) ATmakeAppl(sym__2, j_10, term_j_14);
        t = geq_0_0(t);
        t = e_10;
        t = y_80(t);
        LocalPopChoice(f_23);
          ...
          if((PushChoice() == 0))
          ...
          else
            {
              t = g_23;
              {
                ...
                t = k_11(t);
                g_6 = t;
                t = (ATerm) ATinsert(CheckATermList(g_6), e_11);
                k_1 = t;
...
static ATerm c_7 (ATerm e_36, ATerm f_36, ATerm g_36, ATerm t)
{
  ATerm q_11 = NULL,r_11 = NULL,t_11 = NULL;
  q_11 = t;
  ...
  t_11 = t;
  t = (ATerm) ATmakeAppl(sym__2, t_11, g_36);
  t = b_7(z_1, t_11, g_36, t);
  r_11 = t;
  t = SSL_table_put(e_36, f_36, r_11);
  t = q_11;
  return(t);
}
static ATerm d_7 (ATerm a_81 (ATerm), ATerm o_36, ATerm n_36, ATerm t)
{
  static ATerm b_2 (ATerm t)
  {
    ...
    if(match_cons(t, sym__2))
      ...
      _fail(t);
    t = (ATerm) ATmakeAppl(sym__3, o_36, b_12, e_12);
    t = a_81(t);
    return(t);
  }
  t = n_36;
...
static ATerm e_16 (ATerm e_14, ATerm h_14, ATerm i_14, ATerm t)
{
  ATerm p_14 = NULL,q_14 = NULL,r_14 = NULL,a_15 = NULL,o_1 = NULL;
...
static ATerm f_16 (ATerm i_15, ATerm j_15, ATerm k_15, ATerm t)
{
  ATerm q_15 = NULL,r_15 = NULL,s_15 = NULL,v_15 = NULL,t_1 = NULL;
  ...
  if(((ATgetType(t) == AT_LIST) && ATisEmpty(t)))
  ...
  else
    {
        ...
        _fail(t);
      {
        ...
        if((PushChoice() == 0))
          {
            ATerm f_8 = NULL,i_8 = NULL,o_8 = NULL,x_2 = NULL;
            ...
            t = filter_1_0(l_77, t);
            o_8 = t;
            t = (ATerm) ATinsert(CheckATermList(o_8), i_8);
            x_2 = t;
            t = SSLsetAnnotations(x_2, f_8);
            LocalPopChoice(o_25);
          }
        else
          {
...
static ATerm i_7 (ATerm p_79 (ATerm), ATerm q_34, ATerm o_34, ATerm t)
{
  ...
  t = p_79(t);
  s_21 = t;
  t = (ATerm) ATmakeAppl(sym__3, s_21, q_34, o_34);
  t = r_7(s_21, q_34, o_34, t);
  {
    ATerm v_26 = t;
    int w_26 = stack_ptr;
    if((PushChoice() == 0))
  ...
  t = term_x_26;
  b_22 = t;
  t = (ATerm) ATinsert(CheckATermList(y_21), (ATerm) ATinsert(CheckATermList(x_21), q_34));
  c_22 = t;
    ...
    if((PushChoice() == 0))
      {
        ...
        t = (ATerm) ATmakeAppl(sym__2, w_23, t_9);
        t = j_7(w_23, t_9, t);
          ...
          if((PushChoice() == 0))
            {
              ...
              t = (ATerm) ATmakeAppl(sym__2, w_23, f_10);
              t = j_7(w_23, f_10, t);
              t = (ATerm) ATmakeAppl(sym_FILE_1, w_23);
              LocalPopChoice(j_27);
            }
    ...
    if((PushChoice() == 0))
      {
        ...
        if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
          ...
          _fail(t);
        LocalPopChoice(r_27);
        t = SSL_table_put(m_35, n_35, d_24);
        t = (ATerm) ATmakeAppl(sym__3, m_35, n_35, d_24);
      }
    else
      {
        t = q_27;
...
ATerm xtc_temp_files_1_0 (ATerm h_83 (ATerm), ATerm t)
{
  ...
  static ATerm v_4 (ATerm t)
  {
    ...
    t = map_1_0(x_4, t);
    t = k_25;
    t = end_scope_1_0(b_5, t);
    return(t);
  }
  t = begin_scope_1_0(u_4, t);
  t = restore_always_2_0(h_83, v_4, t);
  return(t);
}
static ATerm d_5 (ATerm t)
{
  ...
  if((PushChoice() == 0))
    {
      ...
      LocalPopChoice(h_29);
      t = xtc_transform_file_2_0(g_5, j_5, t);
    }
  else
    {
      t = f_29;
      t = xtc_transform_term_2_0(s_5, t_5, t);
    }
  {
    ATerm l_29 = t;
    int p_29 = stack_ptr;
    if((PushChoice() == 0))
      ...
      {
        t = l_29;
        t = xtc_transform_term_2_0(y_5, z_5, t);
      }
  }
  return(t);
}
...
static ATerm t_7 (ATerm h_37, ATerm i_37, ATerm t)
{
  ...
  t = term_y_29;
  o_27 = t;
  t = SSL_table_put(o_27, h_37, i_37);
  t = (ATerm) ATmakeAppl(sym__3, term_y_29, h_37, i_37);
  return(t);
}
ATerm Option_3_0 (ATerm c_0 (ATerm), ATerm d_0 (ATerm), ATerm e_0 (ATerm), ATerm t)
{
    ...
    if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
      {
        ...
        {
          ATerm f_12 = NULL,i_12 = NULL,w_3 = NULL;
...
static ATerm l_7 (ATerm n_37, ATerm m_37, ATerm t)
{
  ...
  z_30 = t;
  t = (ATerm) ATmakeAppl(sym__2, m_37, z_30);
  t = conc_0_0(t);
  x_30 = t;
  t = term_y_29;
  a_31 = t;
  t = SSL_table_put(a_31, n_37, x_30);
  t = (ATerm) ATmakeAppl(sym__3, term_y_29, n_37, x_30);
  return(t);
}
static ATerm r_7 (ATerm h_35, ATerm i_35, ATerm g_35, ATerm t)
{
  ...
  e_31 = t;
  t = (ATerm) ATinsert(CheckATermList(e_31), g_35);
  g_31 = t;
  t = SSL_table_put(h_35, i_35, g_31);
  t = d_31;
  return(t);
}
ATerm ArgOption_3_0 (ATerm k_0 (ATerm), ATerm l_0 (ATerm), ATerm n_0 (ATerm), ATerm t)
{
  ATerm u_31 = NULL,v_31 = NULL,z_31 = NULL,a_32 = NULL;
  if(match_string(t, "register-usage-info"))
    {
...
ATerm run_time_0_0 (ATerm t)
{
  ATerm e_33 = NULL,q_12 = NULL,t_12 = NULL;
  t = times_0_0(t);
  t_12 = t;
  ...
  if(match_cons(t, sym__2))
    ...
    _fail(t);
  t = q_12;
  t = foldr_2_0(c_8, g_8, t);
  e_33 = t;
  t = SSL_TicksToSeconds(e_33);
  return(t);
}
ATerm geq_0_0 (ATerm t)
{
    ...
    if((PushChoice() == 0))
      {
        ...
        t = get_config_0_0(t);
        a_35 = t;
        t = (ATerm) ATmakeAppl(sym__2, a_35, term_h_12);
        t = geq_0_0(t);
        t = v_34;
        t = t_80(t);
        LocalPopChoice(t_32);
...
static ATerm h_8 (ATerm t)
{
  ATerm j_35 = NULL,q_35 = NULL,v_35 = NULL,w_35 = NULL;
  t = run_time_0_0(t);
  j_35 = t;
  t = term_a_10;
  t = whoami_0_0(t);
  ...
  t = term_d_12;
  v_35 = t;
  t = (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATempty, term_x_32), j_35), term_k_13), q_35);
  w_35 = t;
  t = SSL_printnl(v_35, w_35);
  t = (ATerm) ATmakeAppl(sym__2, term_d_12, (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATempty, term_x_32), j_35), term_k_13), q_35));
  return(t);
}
ATerm report_run_time_0_0 (ATerm t)
{
      ...
      if(match_cons(t, sym_Undefined_1))
        {
          ...
          {
            ATerm t_13 = NULL,z_3 = NULL;
            t = SSLgetAnnotations(m_36);
            t_13 = t;
            t = (ATerm) ATmakeAppl(sym_Undefined_1, k_36);
            z_3 = t;
            t = SSLsetAnnotations(z_3, t_13);
          }
        }
      else
        {
  ...
  if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
    {
      ...
      w_36 = (ATerm) ATgetNext((ATermList) t);
      {
        ...
        {
          t = (ATerm) ATinsert(CheckATermList(not_null(c_37)), not_null(f_37));
          return(t);
        }
        t = w_36;
        t = i_0(t);
...
static ATerm m_8 (ATerm t)
{
  ATerm l_37 = NULL,o_37 = NULL,p_37 = NULL,i_4 = NULL;
  p_37 = t;
...
static ATerm p_8 (ATerm t)
{
  ATerm w_37 = NULL;
  w_37 = t;
  t = (ATerm) ATinsert(ATinsert(ATempty, w_37), term_f_33);
  t = echo_0_0(t);
  return(t);
}
ATerm default_system_usage_0_0 (ATerm t)
...
ATerm fetch_1_0 (ATerm z_69 (ATerm), ATerm t)
{
  static ATerm w_38 (ATerm t)
  {
      ...
      _fail(t);
    {
      ...
      if((PushChoice() == 0))
        {
          ATerm k_14 = NULL,u_14 = NULL,l_4 = NULL;
      ...
      else
        {
          t = m_33;
          {
            ATerm g_15 = NULL,m_15 = NULL,x_5 = NULL;
            t = SSLgetAnnotations(t_38);
            g_15 = t;
            t = v_38;
            t = w_38(t);
...
ATerm debug_1_0 (ATerm x_64 (ATerm), ATerm t)
{
  ATerm k_39 = NULL,l_39 = NULL,m_39 = NULL,q_39 = NULL;
  k_39 = t;
  t = x_64(t);
  l_39 = t;
  t = term_d_12;
...
ATerm map_1_0 (ATerm p_69 (ATerm), ATerm t)
{
  static ATerm t_40 (ATerm t)
  {
    ...
    if(((ATgetType(t) == AT_LIST) && ATisEmpty(t)))
      ...
      {
        ATerm p_16 = NULL,z_16 = NULL,a_17 = NULL,a_6 = NULL;
        if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
          {
...
ATerm Cons_2_0 (ATerm p_56 (ATerm), ATerm q_56 (ATerm), ATerm t)
{
  ATerm m_42 = NULL,n_42 = NULL,o_42 = NULL,p_42 = NULL,q_42 = NULL,r_42 = NULL,d_6 = NULL;
  r_42 = t;
  if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
    {
  ...
  d_6 = t;
  t = SSLsetAnnotations(d_6, m_42);
  return(t);
}
ATerm parse_options_p__1_0 (ATerm b_87 (ATerm), ATerm t)
{
  ATerm w_42 = NULL,x_42 = NULL,y_42 = NULL,z_42 = NULL,b_43 = NULL,c_43 = NULL,h_6 = NULL;
  w_42 = t;
  {
    ATerm r_34 = t;
    int s_34 = stack_ptr;
          ...
          if((PushChoice() == 0))
            {
              ...
              {
                ATerm l_44 = NULL,m_44 = NULL,n_44 = NULL,l_6 = NULL;
                n_44 = t;
                if(match_cons(t, sym_Undefined_1))
                  {
...
ATerm main_0_0 (ATerm t)
{
  t = option_wrap_4_0(j_9, default_usage_0_0, _id, asfix2abox_0_0, t);
  return(t);
}
