...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_t_21));
  term_t_21 = (ATerm) ATmakeAppl(ATmakeSymbol("-p file   Use pretty-print table in file", 0, ATtrue));
  ATprotect(&(term_y_21));
  ...
  if(match_cons(r_28, sym__2))
    {
      ...
      t_28 = ATgetArgument(r_28, 1);
      {
        ...
        {
          t = (ATerm) ATmakeAppl(sym__3, term_n_21, not_null(s_28), not_null(w_28));
          t = table_put_0(t);
        }
      }
    }
...
{
  ATerm j_29 = NULL,m_29 = NULL,n_29 = NULL,r_29 = NULL,s_29 = NULL;
  j_29 = t;
  h_29 :
      ...
      if(((ATgetType(j_29) == AT_LIST) && !(ATisEmpty(j_29))))
        {
          ...
          if(((ATgetType(n_29) == AT_LIST) && !(ATisEmpty(n_29))))
            {
              r_29 = ATgetFirst((ATermList) n_29);
              s_29 = (ATerm) ATgetNext((ATermList) n_29);
              {
                ATerm w_29 = NULL;
                ATerm o_21;
                o_21 = t;
...
ATerm crush_2 (ATerm t, ATerm u_69 (ATerm), ATerm v_69 (ATerm))
{
  ...
  {
    ATerm u_31 = NULL;
    ATerm y_31 = NULL,z_31 = NULL,c_32 = NULL;
    t = not_null(r_31);
    {
      u_31 = t;
      {
...
ATerm gt_0 (ATerm t)
{
  ATerm s_32 = NULL,v_32 = NULL,w_32 = NULL;
  s_32 = t;
  r_32 :
...
ATerm geq_0 (ATerm t)
{
  ...
  if((PushChoice() == 0))
    {
      ATerm d_33 = NULL,s_33 = NULL,t_33 = NULL;
      d_33 = t;
      b_33 :
      if(match_cons(d_33, sym__2))
        {
          s_33 = ATgetArgument(d_33, 0);
          t_33 = ATgetArgument(d_33, 1);
          {
...
ATerm if_verbose1_1 (ATerm t, ATerm d_59 (ATerm))
{
  ATerm j_5 (ATerm t)
  {
    ...
    k_22 = t;
    {
      ...
      {
        t = (ATerm) ATmakeAppl(sym__2, not_null(x_33), term_t_9);
        t = geq_0(t);
      }
    }
    t = k_22;
...
ATerm report_success_0 (ATerm t)
{
  ATerm k_5 (ATerm t)
  {
    ...
    t = l_22;
    {
      ...
      {
        t = (ATerm) ATmakeAppl(sym__2, term_o_10, (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATempty, term_u_22), not_null(f_34)), term_p_22), not_null(k_34)));
        t = printnl_0(t);
      }
    }
    return(t);
...
ATerm get_config_0 (ATerm t)
{
  ...
  u_45 = t;
  {
    t = (ATerm) ATmakeAppl(sym__2, term_n_21, not_null(u_45));
    {
      t = table_get_0(t);
      {
        ATerm m_6 (ATerm t)
          ...
          t = eval_config_0(t);
          {
            ...
            q_25 = t;
            {
              ...
              if(((w_45 != NULL) && (w_45 != x_45)))
                ...
                w_45 = x_45;
              {
                t = (ATerm) ATmakeAppl(sym__3, term_n_21, not_null(u_45), not_null(w_45));
                t = table_put_0(t);
              }
            }
            t = q_25;
  ...
  if(match_cons(q_49, sym__2))
    {
      ...
      {
        t = (ATerm) ATmakeAppl(sym__3, term_n_21, not_null(r_49), not_null(s_49));
        t = table_put_0(t);
      }
    }
  else
