...
static ATerm i_6 (ATerm z_65 (ATerm), ATerm k_170, ATerm y_17, ATerm t);
...
static ATerm n_6 (ATerm w_74 (ATerm), ATerm x_74 (ATerm), ATerm t_24, ATerm s_24, ATerm t);
static ATerm o_6 (ATerm t_74 (ATerm), ATerm p_24, ATerm o_24, ATerm t);
static ATerm k_1 (ATerm t);
static ATerm p_6 (ATerm f_37, ATerm g_37, ATerm h_37, ATerm t);
static ATerm q_6 (ATerm f_82 (ATerm), ATerm p_37, ATerm o_37, ATerm t);
...
static ATerm s_6 (ATerm z_39, ATerm a_40, ATerm t);
...
ATerm xtc_sglr_1_0 (ATerm h_85 (ATerm), ATerm t);
...
ATerm xtc_temp_files_1_0 (ATerm m_84 (ATerm), ATerm t);
static ATerm e_4 (ATerm t);
ATerm xtc_io_1_0 (ATerm n_84 (ATerm), ATerm t);
...
{
  ATerm d_1 = NULL;
  t = (ATerm) ATmakeAppl(sym__2, k_170, term_s_9);
  t = t_6(t);
  d_1 = t;
...
ATerm xtc_temp_files_1_0 (ATerm m_84 (ATerm), ATerm t)
{
  ...
  t = restore_always_2_0(m_84, a_4, t);
  return(t);
}
static ATerm e_4 (ATerm t)
{
...
ATerm Option_3_0 (ATerm d_0 (ATerm), ATerm g_0 (ATerm), ATerm i_0 (ATerm), ATerm t)
{
  ...
  if(match_string(t, "register-usage-info"))
  ...
  else
    {
      ...
      t = g_0(t);
      n_40 = t;
      t = (ATerm) ATinsert(CheckATermList(h_40), n_40);
    }
  return(t);
}
ATerm Cons_2_0 (ATerm p_57 (ATerm), ATerm q_57 (ATerm), ATerm t)
{
  ATerm o_40 = NULL,s_40 = NULL,t_40 = NULL,u_40 = NULL,v_40 = NULL,w_40 = NULL,v_5 = NULL;
  w_40 = t;
  if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
    {
...
ATerm parse_options_p__1_0 (ATerm g_88 (ATerm), ATerm t)
{
  ATerm h_41 = NULL,i_41 = NULL,j_41 = NULL,k_41 = NULL,o_41 = NULL,q_41 = NULL,a_8 = NULL;
  h_41 = t;
  {
    ATerm m_32 = t;
    int n_32 = stack_ptr;
  ...
  t = term_d_28;
  q_41 = t;
  t = (ATerm) ATmakeAppl(sym__2, term_d_28, j_41);
  t = e_7(q_41, j_41, t);
  t = k_41;
  {
  ...
  o_41 = t;
  t = (ATerm) ATinsert(CheckATermList(o_41), (ATerm) ATmakeAppl(sym_Program_1, j_41));
  a_8 = t;
