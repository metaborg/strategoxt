...
static void init_module_constant_terms (void)
{
  ...
  ATprotect(&(term_s_6));
  term_s_6 = (ATerm) ATmakeAppl(sym_HR_0);
  ATprotect(&(term_e_7));
  term_e_7 = (ATerm) ATmakeAppl(sym_TDTD_0);
  ATprotect(&(term_h_7));
  term_h_7 = (ATerm) ATmakeAppl(ATmakeSymbol("class=\"keyword\"", 0, ATtrue));
  ATprotect(&(term_i_7));
  term_i_7 = (ATerm) ATmakeAppl(ATmakeSymbol("class=\"variable\"", 0, ATtrue));
  ATprotect(&(term_k_7));
  term_k_7 = (ATerm) ATmakeAppl(ATmakeSymbol("class=\"number\"", 0, ATtrue));
  ATprotect(&(term_l_7));
  term_l_7 = (ATerm) ATmakeAppl(ATmakeSymbol("class=\"math\"", 0, ATtrue));
  ATprotect(&(term_m_7));
  term_m_7 = (ATerm) ATmakeAppl(ATmakeSymbol("colspan=\"100\" class=\"comment\"", 0, ATtrue));
}
...
ATerm remove_trailing_1_0 (ATerm o_12 (ATerm), ATerm t);
...
ATerm split_fetch_1_0 (ATerm d_101 (ATerm), ATerm t);
static ATerm v_1 (ATerm v_6, ATerm q_6, ATerm t);
...
static ATerm v_0 (ATerm t)
{
  ATerm j_7 = NULL;
  j_7 = t;
  t = (ATerm) ATinsert(ATinsert(ATempty, term_s_3), j_7);
  return(t);
}
ATerm make_html_comment_0_0 (ATerm t)
{
...
ATerm Hspace_0_0 (ATerm t)
{
  ...
  if(match_int(t, 0))
    ...
    {
      t = (ATerm) ATmakeAppl(sym__2, e_8, term_y_3);
      t = copy_0_0(t);
    }
  return(t);
}
ATerm tov_1_0 (ATerm g_12 (ATerm), ATerm t)
{
  ATerm g_9 = NULL,c_10 = NULL,d_10 = NULL,e_10 = NULL;
  e_10 = t;
  ...
  g_9 = t;
  t = (ATerm) ATmakeAppl(sym_TR_2, (ATerm)ATinsert(ATempty, term_c_4), (ATerm) ATinsert(ATempty, (ATerm) ATmakeAppl(sym_TD_2, (ATerm)ATempty, (ATerm) ATinsert(ATempty, g_9))));
  return(t);
}
static ATerm y_0 (ATerm t)
{
...
static ATerm u_1 (ATerm j_12 (ATerm), ATerm o_8, ATerm t)
{
  ...
  if(match_cons(t, sym_AOPTIONS_1))
    ...
    _fail(t);
  t = (ATerm) ATmakeAppl(sym__2, o_8, u_11);
  {
    ...
    static ATerm x_14 (ATerm t)
    {
      ...
      static ATerm y_14 (ATerm w_11, ATerm x_11, ATerm y_11, ATerm z_11, ATerm a_12, ATerm t)
      {
        ATerm m_12 = NULL,q_12 = NULL,t_12 = NULL;
        t = z_11;
        {
          ATerm l_4 = t;
          int m_4 = stack_ptr;
        ...
        t = x_14(t);
        t_12 = t;
        t = (ATerm) ATinsert(ATinsert(CheckATermList(t_12), q_12), (ATerm) ATmakeAppl(sym_TD_2, (ATerm)ATinsert(ATempty, m_12), w_11));
        return(t);
      }
      static ATerm z_14 (ATerm w_12, ATerm x_12, ATerm y_12, ATerm z_12, ATerm t)
      {
                        ...
                        if((PushChoice() == 0))
                          {
                            ...
                            t = x_14(t);
                            i_14 = t;
                            t = (ATerm) ATinsert(CheckATermList(i_14), (ATerm) ATmakeAppl(sym_TD_2, (ATerm)ATempty, (ATerm) ATinsert(ATempty, (ATerm) ATmakeAppl(sym_C_2, k_13, l_13))));
                            LocalPopChoice(m_5);
                          }
                        else
                          {
...
static ATerm c_1 (ATerm t)
{
  ...
  if((PushChoice() == 0))
    {
      ATerm g_16 = NULL,h_16 = NULL,i_16 = NULL,j_16 = NULL,k_16 = NULL,q_5 = NULL;
      k_16 = t;
      ...
      t = Nil_0_0(t);
      j_16 = t;
      t = (ATerm) ATmakeAppl(sym_R_2, h_16, j_16);
      q_5 = t;
                                      ...
                                      if((PushChoice() == 0))
                                      ...
                                      else
                                        {
                                          t = c_7;
                                          {
                                            ...
                                            b_3 = t;
                                            t = (ATerm) ATinsert(ATinsert(ATempty, b_3), term_e_7);
                                          }
                                        }
                                    }
                                  }
                                  ...
                                  if(match_cons(t, sym_V_2))
                                    {
                                      ...
                                      h_17 = ATgetArgument(t, 1);
                                      {
                                        ...
                                        a_18 = t;
                                        t = (ATerm) ATinsert(ATinsert(ATempty, (ATerm) ATmakeAppl(sym_TABLE_2, (ATerm)ATempty, a_18)), term_e_7);
                                      }
                                    }
                                  else
                                    {
                                                ...
                                                if((PushChoice() == 0))
                                                  {
                                                    if(match_cons(t, sym_KW_0))
                                                      {
                                                        t = (ATerm) ATmakeAppl(sym_SPAN_2, (ATerm)ATinsert(ATempty, term_h_7), (ATerm) ATinsert(ATempty, h_17));
                                                      }
                                                    else
                                                      {
                                                        if(match_cons(t, sym_VAR_0))
                                                          {
                                                            t = (ATerm) ATmakeAppl(sym_SPAN_2, (ATerm)ATinsert(ATempty, term_i_7), (ATerm) ATinsert(ATempty, h_17));
                                                          }
                                                        else
                                                          {
                                                            if(match_cons(t, sym_NUM_0))
                                                              {
                                                                t = (ATerm) ATmakeAppl(sym_SPAN_2, (ATerm)ATinsert(ATempty, term_k_7), (ATerm) ATinsert(ATempty, h_17));
                                                              }
                                                            else
                                                              {
                                              ...
                                              if(match_cons(t, sym_C_2))
                                                {
                                                  ...
                                                  h_17 = ATgetArgument(t, 1);
                                                  {
                                                    ...
                                                    t = map_1_0(t_1, t);
                                                    f_18 = t;
                                                    t = (ATerm) ATmakeAppl(sym_TDTR_1, (ATerm) ATmakeAppl(sym_TR_2, (ATerm)ATempty, (ATerm) ATinsert(ATempty, (ATerm) ATmakeAppl(sym_TD_2, (ATerm)ATinsert(ATempty, term_m_7), (ATerm) ATinsert(ATempty, f_18)))));
                                                  }
                                                }
                                              else
                                                {
...
static ATerm v_1 (ATerm v_6, ATerm q_6, ATerm t)
{
      ...
      if(match_cons(t, sym_V_2))
        {
            ...
            p_18 = ATgetArgument(t, 0);
          {
            ...
            if(((ATgetType(o_7) == AT_LIST) && !(ATisEmpty(o_7))))
              {
                if(((k_18 != NULL) && (k_18 != ATgetFirst((ATermList) o_7))))
                  _fail(ATgetFirst((ATermList) o_7));
                else
                  k_18 = ATgetFirst((ATermList) o_7);
                if(((l_18 != NULL) && (l_18 != (ATerm) ATgetNext((ATermList) o_7))))
                  _fail((ATerm) ATgetNext((ATermList) o_7));
                else
                  l_18 = (ATerm) ATgetNext((ATermList) o_7);
              }
            else
              _fail(t);
          }
  ...
  t = (ATerm) ATinsert(CheckATermList(not_null(l_18)), not_null(k_18));
  {
    ...
    static ATerm x_1 (ATerm t)
    {
      ...
      t = (ATerm) ATinsert(ATempty, (ATerm) ATmakeAppl(sym_H_2, v_6, (ATerm) ATinsert(CheckATermList(n_18), not_null(m_18))));
      return(t);
    }
    t = at_last_1_0(x_1, t);
  }
  ...
  t = conc_0_0(t);
  r_18 = t;
  t = (ATerm) ATmakeAppl(sym_H_2, v_6, r_18);
  return(t);
}
static ATerm a_2 (ATerm t)
{
