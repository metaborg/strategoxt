...
static void init_module_constant_terms (void)
{
  ...
  ATprotect(&(term_y_9));
  term_y_9 = (ATerm) ATmakeAppl(sym_lit_1, term_x_9);
  ATprotect(&(term_z_9));
  term_z_9 = (ATerm) ATmakeAppl(ATmakeSymbol(")", 0, ATtrue));
  ATprotect(&(term_a_10));
  term_a_10 = (ATerm) ATmakeAppl(sym_lit_1, term_z_9);
  ATprotect(&(term_j_10));
  term_j_10 = (ATerm) ATmakeAppl(ATmakeSymbol("\"pp-tables-0\"", 0, ATtrue));
}
...
ATerm xtc_ast2abox_1_0 (ATerm z_21 (ATerm), ATerm t);
...
ATerm symbol2abox_1_0 (ATerm q_21 (ATerm), ATerm t);
...
ATerm number_node_1_0 (ATerm t_21 (ATerm), ATerm t);
static ATerm p_3 (ATerm t);
static ATerm v_3 (ATerm t);
ATerm number_nonterminals_0_0 (ATerm t);
ATerm symbols2pp_entries_1_0 (ATerm p_21 (ATerm), ATerm t);
...
ATerm add_arg_flags_0_0 (ATerm t)
{
  ...
  if(((ATgetType(t) == AT_LIST) && ATisEmpty(t)))
  ...
  else
    {
      ...
      t = separate_by_0_0(t);
      z_0 = t;
      t = (ATerm) ATinsert(CheckATermList(z_0), k_0);
    }
  return(t);
}
static ATerm a_0 (ATerm t)
...
ATerm ignore_prod_0_0 (ATerm t)
{
  ATerm i_3 = NULL,n_3 = NULL,o_3 = NULL,q_3 = NULL,r_3 = NULL,s_3 = NULL,t_3 = NULL,w_3 = NULL,y_3 = NULL;
  r_3 = t;
...
ATerm symbol2abox_1_0 (ATerm q_21 (ATerm), ATerm t)
{
  ...
  static ATerm z_13 (ATerm t)
  {
    ...
    if((PushChoice() == 0))
      {
        ATerm p_9 = NULL,q_9 = NULL,r_9 = NULL,s_9 = NULL,s_10 = NULL,t_10 = NULL,b_11 = NULL,d_11 = NULL,s_11 = NULL,c_12 = NULL;
        if(match_cons(t, sym__2))
          {
                      ...
                      else
                        {
                          t = v_7;
                          {
                            ...
                            if(((m_9 != NULL) && (m_9 != t)))
                              ...
                              m_9 = t;
                            t = (ATerm) ATmakeAppl(sym_alt_2, b_11, (ATerm) ATmakeAppl(sym_alt_2, s_11, c_12));
                            t = flat_alt_0_0(t);
                            i_12 = t;
                            t = (ATerm) ATmakeAppl(sym__2, term_g_8, i_12);
                            t = mkterm_0_0(t);
                            j_12 = t;
                            t = (ATerm) ATmakeAppl(sym__2, (ATerm)ATmakeAppl(sym__2, q_9, r_9), (ATerm) ATmakeAppl(sym__2, s_10, j_12));
                            t = z_13(t);
...
static ATerm b_3 (ATerm t)
{
  ATerm r_16 = NULL,s_16 = NULL,t_16 = NULL,v_16 = NULL,o_0 = NULL;
  t_16 = t;
  if(match_cons(t, sym_lit_1))
    {
  ...
  if(match_cons(t, sym_prod_fun_4))
    {
      ...
      {
        ATerm f_21 = NULL;
        t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, (ATerm) ATinsert(ATempty, term_a_10)), z_20), (ATerm) ATinsert(ATinsert(ATempty, term_y_9), (ATerm) ATmakeAppl(sym_lit_1, y_20)));
        t = concat_0_0(t);
        f_21 = t;
        t = (ATerm) ATmakeAppl(sym_prod_3, f_21, a_21, w_20);
...
static ATerm w_23 (ATerm m_22, ATerm n_22, ATerm t)
{
  ATerm o_22 = NULL,q_22 = NULL,f_8 = NULL;
...
ATerm ppgenerate_0_0 (ATerm t)
{
  ...
  t = concat_0_0(t);
  x_21 = t;
  t = (ATerm) ATmakeAppl(sym_PP_Table_1, x_21);
  t = topdown_1_0(j_4, t);
  return(t);
}
static ATerm l_4 (ATerm t)
