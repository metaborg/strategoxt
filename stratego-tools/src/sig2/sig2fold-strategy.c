...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_s_30));
  term_s_30 = (ATerm) ATmakeAppl(ATmakeSymbol("tg2fold-strategy", 0, ATtrue));
}
...
ATerm io_sig2fold_strategy_0_0 (ATerm);
...
ATerm io_sig2fold_strategy_0_0 (ATerm t)
{
  ATerm a_9 (ATerm t)
  {
    t = term_s_30;
