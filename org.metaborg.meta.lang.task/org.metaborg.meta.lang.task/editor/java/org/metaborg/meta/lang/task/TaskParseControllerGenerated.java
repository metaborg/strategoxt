...
public class TaskParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Task");
  ...
  { 
    TaskParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = TaskParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TaskParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TaskParseControllerGenerated.class);
    }
  ...
  { 
    return TaskParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
