...
public class AnalysisParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Analysis");
  ...
  { 
    AnalysisParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = AnalysisParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = AnalysisParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(AnalysisParseControllerGenerated.class);
    }
  ...
  { 
    return AnalysisParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
