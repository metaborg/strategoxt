...
[
  ...
  if test "${STRATEGO_LIBRARIES:+set}" = set; then
    ...
    if test "${STRATEGOXT:+set}" = set; then
      ...
      XT_CHECK_PACKAGE([STRATEGO_AG],[stratego-ag])
    fi
  fi
...
[
  ...
  AC_SUBST([STRATEGO_LAZY], ['$(STRATEGO_LIBRARIES)'])
  AC_SUBST([STRATEGO_LAZY_CFLAGS], ['-I$(STRATEGO_LAZY)/include'])
  AC_SUBST([STRATEGO_LAZY_LIBS], ['-L$(STRATEGO_LAZY)/lib -lstratego-lazy'])
  AC_SUBST([STRATEGO_LAZY_STRCFLAGS], ['-I $(STRATEGO_LAZY)/share --C-include "\"stratego-lazy/stratego-lazy.h\""'])

  AC_SUBST([STRATEGO_SREF], ['$(STRATEGO_LIBRARIES)'])
  AC_SUBST([STRATEGO_SREF_CFLAGS], [''])
  AC_SUBST([STRATEGO_SREF_LIBS], ['-L$(STRATEGO_SREF)/lib -lstratego-sref'])
  AC_SUBST([STRATEGO_SREF_STRCFLAGS], ['-I $(STRATEGO_SREF)/share'])

  AC_SUBST([STRATEGO_AG], ['$(STRATEGO_LIBRARIES)'])
  AC_SUBST([STRATEGO_AG_CFLAGS], [''])
  AC_SUBST([STRATEGO_AG_LIBS], ['-L$(STRATEGO_AG)/lib -lstratego-ag'])
  AC_SUBST([STRATEGO_AG_STRCFLAGS], ['-I $(STRATEGO_AG)/share'])
])
