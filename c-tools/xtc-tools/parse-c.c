...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_t_24));
  term_t_24 = (ATerm) ATmakeAppl(ATmakeSymbol("C.tbl", 0, ATtrue));
  ATprotect(&(term_w_24));
  term_w_24 = (ATerm) ATmakeAppl(ATmakeSymbol("-2tA", 0, ATtrue));
  ATprotect(&(term_x_24));
  term_x_24 = (ATerm) ATmakeAppl(ATmakeSymbol("-p", 0, ATtrue));
  ATprotect(&(term_y_24));
  term_y_24 = (ATerm) ATmakeAppl(ATmakeSymbol("implode-asfix", 0, ATtrue));
}
...
ATerm io_parse_c_0 (ATerm t)
{
  ATerm c_5 (ATerm t)
  {
    ...
    ATerm e_5 (ATerm t)
    {
      ...
      t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, not_null(p_43)), term_x_24), term_w_24);
      return(t);
    }
