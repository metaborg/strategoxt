...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_f_25));
  term_f_25 = (ATerm) ATmakeAppl(ATmakeSymbol("sglr", 0, ATtrue));
  ATprotect(&(term_g_25));
  term_g_25 = (ATerm) ATmakeAppl(ATmakeSymbol("C.tbl", 0, ATtrue));
  ATprotect(&(term_h_25));
  term_h_25 = (ATerm) ATmakeAppl(ATmakeSymbol("-2tA", 0, ATtrue));
  ATprotect(&(term_i_25));
  term_i_25 = (ATerm) ATmakeAppl(ATmakeSymbol("-p", 0, ATtrue));
  ATprotect(&(term_j_25));
  term_j_25 = (ATerm) ATmakeAppl(ATmakeSymbol("implode-asfix", 0, ATtrue));
}
...
ATerm error_0 (ATerm t)
{
  ...
  v_5 = t;
  {
    ...
    if(((i_3 != NULL) && (i_3 != j_3)))
      ...
      i_3 = j_3;
    {
      t = (ATerm) ATmakeAppl(sym__2, term_w_5, not_null(i_3));
      t = printnl_0(t);
    }
  }
  t = v_5;
...
ATerm io_parse_c_0 (ATerm t)
{
  ATerm d_5 (ATerm t)
  {
    ...
    ATerm f_5 (ATerm t)
    {
      ...
      t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, not_null(m_43)), term_i_25), term_h_25);
      return(t);
    }
