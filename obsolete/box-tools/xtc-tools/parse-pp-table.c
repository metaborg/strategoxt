...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_k_21));
  term_k_21 = (ATerm) ATmakeAppl(sym__2, term_g_21, term_j_21);
  ATprotect(&(term_l_21));
  ...
  ATprotect(&(term_w_23));
  term_w_23 = (ATerm) ATmakeAppl(sym__2, term_v_23, term_c_13);
  ATprotect(&(term_x_23));
  ...
  ATprotect(&(term_x_24));
  term_x_24 = (ATerm) ATmakeAppl(sym__3, term_g_21, term_j_21, (ATerm) ATempty);
  ATprotect(&(term_n_25));
...
ATerm if_verbose3_1 (ATerm, ATerm d_59 (ATerm));
...
ATerm if_verbose3_1 (ATerm t, ATerm d_59 (ATerm))
{
  ATerm e_0 (ATerm t)
  {
    ATerm p_7;
  ...
  if(match_cons(q_19, sym__2))
    {
      ...
      s_19 = ATgetArgument(q_19, 1);
      {
        ...
        f_15 = t;
        {
          ATerm a_20 = NULL;
          ATerm b_20 = NULL;
          t = (ATerm) ATmakeAppl(sym__2, not_null(r_19), not_null(s_19));
          {
            ATerm g_15 = t;
            int j_15 = stack_ptr;
            if((PushChoice() == 0))
          ...
          {
            t = (ATerm) ATmakeAppl(sym__3, not_null(r_19), not_null(s_19), not_null(a_20));
            t = table_put_0(t);
          }
        }
        t = f_15;
          ...
          m_20 = n_20;
        {
            ...
            }
          {
            ...
            if(((ATgetType(t_20) == AT_LIST) && !(ATisEmpty(t_20))))
              {
                u_20 = ATgetFirst((ATermList) t_20);
                v_20 = (ATerm) ATgetNext((ATermList) t_20);
                {
                  if(((l_20 != NULL) && (l_20 != u_20)))
                    _fail(u_20);
                  else
                    l_20 = u_20;
                  {
                    if(((k_20 != NULL) && (k_20 != v_20)))
                      _fail(v_20);
                    else
                      k_20 = v_20;
                    {
    ...
    t = u_74(t);
    {
      i_21 = t;
      {
          ...
          h_21 = i_21;
        {
          ...
          {
            t = (ATerm) ATmakeAppl(sym__3, not_null(h_21), term_f_12, (ATerm) ATinsert(CheckATermList(not_null(o_21)), (ATerm) ATempty));
            t = table_put_0(t);
          }
        }
      }
...
ATerm output_option_0 (ATerm t)
{
  ATerm j_3 (ATerm t)
  {
    ...
    z_23 = t;
    r_23 :
    if(!(match_string(z_23, "-o")))
      {
        if(!(match_string(z_23, "--output")))
          {
            _fail(t);
          }
      }
  ...
  ATerm k_3 (ATerm t)
  {
    ...
    g_18 = t;
    {
      ...
      if(((a_24 != NULL) && (a_24 != b_24)))
        ...
        a_24 = b_24;
      {
        t = (ATerm) ATmakeAppl(sym__2, term_o_13, not_null(a_24));
        t = set_config_0(t);
      }
    }
    t = g_18;
    {
      ...
      if(((c_24 != NULL) && (c_24 != d_24)))
        ...
        c_24 = d_24;
      t = (ATerm) ATmakeAppl(sym_Output_1, not_null(c_24));
    }
    return(t);
  }
  ATerm m_3 (ATerm t)
...
{
  ATerm q_24 = NULL,s_24 = NULL,t_24 = NULL,u_24 = NULL,v_24 = NULL;
  q_24 = t;
  l_24 :
  if(match_string(q_24, "register-usage-info"))
    {
  ...
  else
    {
      if(((ATgetType(q_24) == AT_LIST) && !(ATisEmpty(q_24))))
        {
          s_24 = ATgetFirst((ATermList) q_24);
          t_24 = (ATerm) ATgetNext((ATermList) q_24);
          m_24 :
          if(((ATgetType(t_24) == AT_LIST) && !(ATisEmpty(t_24))))
            {
              ...
              v_24 = (ATerm) ATgetNext((ATermList) t_24);
              {
                ...
                t = w_18;
                {
                  ...
                  t = (ATerm) ATinsert(CheckATermList(not_null(v_24)), not_null(z_24));
                }
              }
            }
          else
  ...
  a_29 = t;
  {
    ...
    q_20 = t;
    {
      t = term_r_20;
      {
        t = table_create_0(t);
        {
          t = (ATerm) ATmakeAppl(sym__3, term_r_20, term_s_20, not_null(a_29));
          t = table_put_0(t);
        }
      }
    }
              ...
              t = reverse_0(t);
              {
                ATerm e_5 (ATerm t)
                {
                  ...
                  if(((i_32 != NULL) && (i_32 != j_32)))
                    ...
                    i_32 = j_32;
                  {
                    t = (ATerm) ATinsert(ATinsert(ATempty, not_null(i_32)), term_l_21);
                    t = echo_0(t);
                  }
                  return(t);
                }
                t = map_1(t, e_5);
                {
                  ATerm f_5 (ATerm t)
                  {
                    ...
                    {
                      t = (ATerm) ATinsert(CheckATermList(not_null(k_32)), term_m_21);
                      t = echo_0(t);
                    }
                    return(t);
                  }
...
ATerm debug_0 (ATerm t)
{
  ...
  n_21 = t;
  {
    ...
    if(((v_32 != NULL) && (v_32 != w_32)))
      ...
      v_32 = w_32;
    {
      t = (ATerm) ATmakeAppl(sym__2, term_d_8, (ATerm) ATinsert(ATempty, not_null(v_32)));
      t = printnl_0(t);
    }
  }
  t = n_21;
        ...
        }
        {
          t = not_null(e_33);
          {
            ...
            t = w_52(t);
            {
              ...
              {
                ATerm z_33 = NULL;
                t = SSLsetAnnotations((ATerm)ATmakeAppl(sym_Undefined_1, not_null(t_33)), not_null(r_33));
                {
                  z_33 = t;
  ...
  if(match_cons(x_34, sym_Help_0))
    {
      ...
      {
        ATerm d_35 = NULL;
        t = SSLsetAnnotations((ATerm)ATmakeAppl(sym_Help_0), not_null(a_35));
        {
          d_35 = t;
...
ATerm implode_string_0 (ATerm t)
{
  ATerm o_35 = NULL;
  o_35 = t;
  t = SSL_implode_string(not_null(o_35));
  return(t);
}
  ...
  else
    {
      t = u_21;
      {
        ...
        if(((ATgetType(t_35) == AT_LIST) && !(ATisEmpty(t_35))))
          {
            y_35 = ATgetFirst((ATermList) t_35);
            z_35 = (ATerm) ATgetNext((ATermList) t_35);
            {
              t = not_null(y_35);
              {
                ATerm l_5 (ATerm t)
...
ATerm register_usage_1 (ATerm t, ATerm n_77 (ATerm))
{
  ...
  {
    t = (ATerm) ATmakeAppl(sym__3, term_g_21, term_j_21, not_null(f_41));
    {
      t = table_push_0(t);
      _fail(t);
    }
              ...
              a_43 = t;
              {
                t = not_null(q_42);
                {
                  ...
                  t = c_52(t);
                  {
                    ...
                    {
                      ATerm f_43 = NULL;
                      t = SSLsetAnnotations((ATerm)ATinsert(CheckATermList(not_null(c_43)), not_null(a_43)), not_null(w_42));
                      {
                        f_43 = t;
