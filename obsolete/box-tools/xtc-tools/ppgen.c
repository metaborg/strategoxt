...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_y_18));
  term_y_18 = (ATerm) ATmakeAppl(ATmakeSymbol("-i f|--input f   Read input from f", 0, ATtrue));
  ATprotect(&(term_k_19));
  ...
  ATprotect(&(term_u_24));
  term_u_24 = (ATerm) ATmakeAppl(ATmakeSymbol("-h|-?|--help     Display usage information", 0, ATtrue));
  ATprotect(&(term_y_24));
...
ATerm repeat_1 (ATerm, ATerm k_77 (ATerm));
...
ATerm obsolete_1 (ATerm, ATerm t_75 (ATerm));
...
ATerm stdin_0 (ATerm);
ATerm FILE_1 (ATerm, ATerm v_52 (ATerm));
...
ATerm _2 (ATerm, ATerm z_50 (ATerm), ATerm a_51 (ATerm));
ATerm conc_strings_0 (ATerm);
ATerm printnl_0 (ATerm);
ATerm debug_1 (ATerm, ATerm m_75 (ATerm));
...
ATerm repeat_1 (ATerm t, ATerm k_77 (ATerm))
{
  ATerm h_8 (ATerm t)
  {
    ATerm r_0 (ATerm t)
...
ATerm obsolete_1 (ATerm t, ATerm t_75 (ATerm))
{
  ATerm b_12;
  b_12 = t;
  {
...
ATerm FILE_1 (ATerm t, ATerm v_52 (ATerm))
{
                  ...
                  t = m_0(t);
                  {
                    d_19 = t;
                    {
                        ...
                        c_19 = d_19;
                      {
                        ...
                        {
                          t = (ATerm) ATmakeAppl(sym__2, not_null(t_18), not_null(c_19));
                          t = copy_file_0(t);
                        }
                      }
                    }
...
ATerm table_pop_0 (ATerm t)
{
  ...
  if(match_cons(z_19, sym__2))
    {
      f_20 = ATgetArgument(z_19, 0);
      g_20 = ATgetArgument(z_19, 1);
      {
        ATerm f_15;
        f_15 = t;
        {
    ...
    t = c_75(t);
    {
      b_21 = t;
      {
          ...
          a_21 = b_21;
        {
          ...
          if((PushChoice() == 0))
            {
              t = (ATerm) ATmakeAppl(sym__2, not_null(a_21), term_a_12);
              t = table_get_0(t);
              LocalPopChoice(o_15);
            }
          else
                ...
                e_21 = (ATerm) ATgetNext((ATermList) c_21);
                {
                    ...
                    u_20 = d_21;
                  {
                    if(((t_20 != NULL) && (t_20 != e_21)))
                      ...
                      t_20 = e_21;
                    {
                      t = (ATerm) ATmakeAppl(sym__3, not_null(a_21), term_a_12, not_null(t_20));
                      {
                        t = table_put_0(t);
                        {
                          t = not_null(u_20);
  ...
  u_15 = t;
  {
    ...
    t = b_75(t);
    {
      w_21 = t;
      {
        ...
        {
          ATerm y_21 = NULL;
          t = (ATerm) ATmakeAppl(sym__2, not_null(v_21), term_a_12);
          {
            ATerm v_15 = t;
            int z_15 = stack_ptr;
            if((PushChoice() == 0))
          ...
          {
            t = (ATerm) ATmakeAppl(sym__3, not_null(v_21), term_a_12, (ATerm) ATinsert(CheckATermList(not_null(x_21)), (ATerm) ATempty));
            t = table_put_0(t);
          }
        }
      }
...
ATerm output_option_0 (ATerm t)
{
  ATerm m_3 (ATerm t)
  {
    ...
    i_24 = t;
    a_24 :
    if(!(match_string(i_24, "-o")))
      {
        if(!(match_string(i_24, "--output")))
          {
            _fail(t);
          }
      }
...
ATerm ArgOption_3 (ATerm t, ATerm j_0 (ATerm), ATerm k_0 (ATerm), ATerm l_0 (ATerm))
{
  ...
  a_25 = t;
  x_24 :
  if(match_string(a_25, "register-usage-info"))
    {
...
ATerm default_usage_0 (ATerm t)
{
  ...
  x_19 = t;
  {
    ...
    {
      t = (ATerm) ATmakeAppl(sym__2, term_m_7, (ATerm) ATinsert(ATinsert(ATinsert(ATempty, term_b_20), not_null(d_26)), term_a_20));
      {
        t = printnl_0(t);
        {
          t = term_v_6;
...
{
  t = (ATerm) ATmakeAppl(sym__2, term_m_7, (ATerm) ATinsert(ATempty, term_c_20));
  {
    t = printnl_0(t);
    {
      t = term_v_6;
...
ATerm report_success_0 (ATerm t)
{
  ATerm q_4 (ATerm t)
  {
    ...
    t = r_20;
    {
      ...
      {
        t = (ATerm) ATmakeAppl(sym__2, term_m_7, (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATempty, term_x_20), not_null(p_28)), term_w_20), not_null(r_28)));
        t = printnl_0(t);
      }
    }
    return(t);
              ...
              t = reverse_0(t);
              {
                ATerm a_5 (ATerm t)
                {
                  ...
                  if(((x_32 != NULL) && (x_32 != y_32)))
                    ...
                    x_32 = y_32;
                  {
                    t = (ATerm) ATinsert(ATinsert(ATempty, not_null(x_32)), term_c_22);
                    t = echo_0(t);
                  }
                  return(t);
                }
                t = map_1(t, a_5);
                {
                  ATerm e_5 (ATerm t)
                  {
                    ...
                    {
                      t = (ATerm) ATinsert(CheckATermList(not_null(b_33)), term_d_22);
                      t = echo_0(t);
                    }
                    return(t);
                  }
...
ATerm say_1 (ATerm t, ATerm n_75 (ATerm))
{
  ATerm f_22;
  f_22 = t;
  {
        ...
        }
        {
          t = not_null(b_34);
          {
            ...
            t = v_57(t);
            {
              ...
              {
                ATerm q_34 = NULL;
                t = SSLsetAnnotations((ATerm)ATmakeAppl(sym_Undefined_1, not_null(k_34)), not_null(h_34));
                {
                  q_34 = t;
...
ATerm _2 (ATerm t, ATerm z_50 (ATerm), ATerm a_51 (ATerm))
{
...
ATerm debug_1 (ATerm t, ATerm m_75 (ATerm))
{
  ATerm w_22;
  w_22 = t;
  {
...
ATerm get_config_0 (ATerm t)
{
  ...
  n_40 = t;
  {
    t = (ATerm) ATmakeAppl(sym__2, term_c_24, not_null(n_40));
    {
      t = table_get_0(t);
      {
        ATerm q_5 (ATerm t)
          ...
          t = eval_config_0(t);
          {
            ...
            d_24 = t;
            {
              ...
              if(((p_40 != NULL) && (p_40 != q_40)))
                ...
                p_40 = q_40;
              {
                t = (ATerm) ATmakeAppl(sym__3, term_c_24, not_null(n_40), not_null(p_40));
                t = table_put_0(t);
              }
            }
            t = d_24;
...
{
  ATerm e_41 = NULL,h_41 = NULL,i_41 = NULL,j_41 = NULL;
  e_41 = t;
  d_41 :
  if(match_cons(e_41, sym__3))
    {
      h_41 = ATgetArgument(e_41, 0);
      i_41 = ATgetArgument(e_41, 1);
      j_41 = ATgetArgument(e_41, 2);
      {
        ATerm g_24;
        g_24 = t;
        {
          ATerm p_41 = NULL;
          ATerm q_41 = NULL;
          t = (ATerm) ATmakeAppl(sym__2, not_null(h_41), not_null(i_41));
          {
            ATerm h_24 = t;
            int n_24 = stack_ptr;
            if((PushChoice() == 0))
          ...
          {
            t = (ATerm) ATmakeAppl(sym__3, not_null(h_41), not_null(i_41), (ATerm) ATinsert(CheckATermList(not_null(p_41)), not_null(j_41)));
            t = table_put_0(t);
          }
        }
        t = g_24;
  ...
  if(((ATgetType(v_42) == AT_LIST) && !(ATisEmpty(v_42))))
    {
      ...
      t = (ATerm) ATinsert(CheckATermList(not_null(x_42)), (ATerm) ATmakeAppl(sym_Undefined_1, not_null(w_42)));
    }
  else
    {
      _fail(t);
  ...
  t = w_24;
  {
    ATerm a_6 (ATerm t)
    {
      ...
      f_25 = t;
      {
        ...
        ATerm e_45 = NULL;
        e_45 = t;
        if(((x_44 != NULL) && (x_44 != e_45)))
          _fail(e_45);
        else
          x_44 = e_45;
        {
          t = (ATerm) ATmakeAppl(sym__2, term_v_20, not_null(x_44));
          t = set_config_0(t);
        }
      }
      t = f_25;
      {
        ...
        if(((f_45 != NULL) && (f_45 != g_45)))
          ...
          f_45 = g_45;
        t = (ATerm) ATmakeAppl(sym_Program_1, not_null(f_45));
      }
      return(t);
    }
    ATerm b_6 (ATerm t)
...
ATerm table_put_0 (ATerm t)
{
  ...
  m_25 = t;
  {
    ATerm r_45 = NULL,x_45 = NULL,y_45 = NULL,z_45 = NULL;
    r_45 = t;
    m_45 :
    if(match_cons(r_45, sym__3))
      {
        x_45 = ATgetArgument(r_45, 0);
        y_45 = ATgetArgument(r_45, 1);
        z_45 = ATgetArgument(r_45, 2);
        {
          if(((n_45 != NULL) && (n_45 != x_45)))
            _fail(x_45);
          else
            n_45 = x_45;
          {
            if(((o_45 != NULL) && (o_45 != y_45)))
              _fail(y_45);
            else
              o_45 = y_45;
            {
              if(((q_45 != NULL) && (q_45 != z_45)))
                _fail(z_45);
              else
                q_45 = z_45;
              t = SSL_table_put(not_null(n_45), not_null(o_45), not_null(q_45));
            }
          }
        }
      }
