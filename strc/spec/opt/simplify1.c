...
static ATerm f_11 (ATerm r_137 (ATerm), ATerm y_465, ATerm k_52, ATerm t);
...
static ATerm h_11 (ATerm c_45, ATerm d_45, ATerm t);
...
{
  ATerm n_50 = NULL;
  t = (ATerm) ATmakeAppl(sym__2, y_465, term_c_22);
  t = j_11(t);
  n_50 = t;
