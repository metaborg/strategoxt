...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_t_14));
  term_t_14 = (ATerm) ATmakeAppl(ATmakeSymbol("b_0", 0, ATtrue));
  ATprotect(&(term_u_14));
...
ATerm default_usage_0_0 (ATerm t)
{
  ...
  t = term_k_8;
  q_0 = t;
  t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, term_m_8), c_0), term_l_8);
  r_0 = t;
                      ...
                      if(match_cons(t, sym_Defined_1))
                        {
                          ...
                          if((ATgetSymbol((ATermAppl) b_13) != ATmakeSymbol("b_0", 0, ATtrue)))
                            _fail(t);
                        }
                      else
                        _fail(t);
