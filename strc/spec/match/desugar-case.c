...
static void init_module_constant_terms (void)
{
  ...
  ATprotect(&(term_d_4));
  term_d_4 = (ATerm) ATmakeAppl(sym__2, term_n_3, term_x_3);
  ATprotect(&(term_h_4));
  ...
  ATprotect(&(term_h_6));
  term_h_6 = (ATerm) ATmakeAppl(ATmakeSymbol("-i", 0, ATtrue));
  ATprotect(&(term_j_6));
  term_j_6 = (ATerm) ATmakeAppl(sym__2, term_n_3, term_h_6);
  ATprotect(&(term_l_6));
  term_l_6 = (ATerm) ATmakeAppl(sym_stdin_0);
  ATprotect(&(term_m_6));
  term_m_6 = (ATerm) ATmakeAppl(ATmakeSymbol("program", 0, ATtrue));
  ATprotect(&(term_p_6));
  term_p_6 = (ATerm) ATmakeAppl(sym__2, term_n_3, term_m_6);
  ATprotect(&(term_d_7));
...
ATerm repeat_2_0 (ATerm r_102 (ATerm), ATerm s_102 (ATerm), ATerm t);
ATerm topdown_1_0 (ATerm r_103 (ATerm), ATerm t);
static ATerm o_3 (ATerm p_52, ATerm q_52, ATerm t);
static ATerm p_3 (ATerm u_36, ATerm v_36, ATerm t);
static ATerm r_3 (ATerm u_109 (ATerm), ATerm f_234, ATerm a_37, ATerm t);
static ATerm q_3 (ATerm q_36, ATerm r_36, ATerm t);
static ATerm b_0 (ATerm t);
static ATerm c_0 (ATerm t);
ATerm output_1_0 (ATerm d_129 (ATerm), ATerm t);
static ATerm b_7 (ATerm i_6, ATerm t);
ATerm fclose_0_0 (ATerm t);
static ATerm s_3 (ATerm w_36, ATerm t);
static ATerm t_3 (ATerm t_50, ATerm u_50, ATerm t);
static ATerm u_3 (ATerm r_52, ATerm s_52, ATerm t);
...
ATerm input_1_0 (ATerm e_129 (ATerm), ATerm t);
ATerm default_system_about_0_0 (ATerm t);
ATerm echo_0_0 (ATerm t);
ATerm map_1_0 (ATerm d_110 (ATerm), ATerm t);
ATerm reverse_acc_2_0 (ATerm m_0 (ATerm), ATerm o_0 (ATerm), ATerm t);
static ATerm i_0 (ATerm t);
static ATerm k_0 (ATerm t);
static ATerm q_0 (ATerm t);
ATerm default_system_usage_2_0 (ATerm c_131 (ATerm), ATerm d_131 (ATerm), ATerm t);
...
static ATerm e_4 (ATerm n_71, ATerm o_71, ATerm t);
ATerm Option_3_0 (ATerm d_0 (ATerm), ATerm f_0 (ATerm), ATerm g_0 (ATerm), ATerm t);
static ATerm u_1 (ATerm t);
static ATerm v_1 (ATerm t);
static ATerm w_1 (ATerm t);
ATerm output_option_0_0 (ATerm t);
static ATerm c_4 (ATerm w_57, ATerm x_57, ATerm v_57, ATerm t);
...
static ATerm w_3 (ATerm f_56, ATerm g_56, ATerm t);
ATerm foldr_2_0 (ATerm c_117 (ATerm), ATerm d_117 (ATerm), ATerm t);
...
static ATerm f_4 (ATerm o_62, ATerm p_62, ATerm q_62, ATerm t);
ATerm lookup_table_0_1 (ATerm i_59, ATerm t);
ATerm new_hashtable_0_2 (ATerm w_62, ATerm x_62, ATerm t);
ATerm table_create_0_0 (ATerm t);
static ATerm y_3 (ATerm t_62, ATerm u_62, ATerm t);
static ATerm z_3 (ATerm y_62, ATerm t);
ATerm table_hashtable_0_0 (ATerm t);
ATerm table_destroy_0_0 (ATerm t);
ATerm fetch_1_0 (ATerm n_110 (ATerm), ATerm t);
static ATerm g_4 (ATerm r_62, ATerm s_62, ATerm t);
static ATerm b_4 (ATerm p_59, ATerm q_59, ATerm t);
...
ATerm Cons_2_0 (ATerm l_87 (ATerm), ATerm m_87 (ATerm), ATerm t);
ATerm parse_options_p__1_0 (ATerm x_130 (ATerm), ATerm t);
static ATerm n_2 (ATerm t);
static ATerm o_2 (ATerm t);
static ATerm p_2 (ATerm t);
static ATerm q_2 (ATerm t);
ATerm parse_options_3_0 (ATerm u_130 (ATerm), ATerm v_130 (ATerm), ATerm w_130 (ATerm), ATerm t);
ATerm option_wrap_5_0 (ATerm x_128 (ATerm), ATerm y_128 (ATerm), ATerm z_128 (ATerm), ATerm a_129 (ATerm), ATerm b_129 (ATerm), ATerm t);
...
ATerm DesugarCase_0_0 (ATerm t)
{
  ATerm n_0 = NULL,p_0 = NULL,a_1 = NULL,b_1 = NULL,k_1 = NULL,m_1 = NULL,p_1 = NULL,q_1 = NULL,r_1 = NULL,t_1 = NULL;
          ...
          if(match_cons(t, sym_Real_1))
            {
              ...
              t = (ATerm) ATmakeAppl(sym_GuardedLChoice_3, (ATerm)ATmakeAppl(sym_Match_1, (ATerm) ATmakeAppl(sym_Real_1, p_0)), b_1, (ATerm) ATmakeAppl(sym_Case_2, k_1, q_1));
            }
          else
            {
              if(match_cons(t, sym_Int_1))
                {
                  p_0 = ATgetArgument(t, 0);
                  t = (ATerm) ATmakeAppl(sym_GuardedLChoice_3, (ATerm)ATmakeAppl(sym_Match_1, (ATerm) ATmakeAppl(sym_Int_1, p_0)), b_1, (ATerm) ATmakeAppl(sym_Case_2, k_1, q_1));
                }
              else
                {
                  if(match_cons(t, sym_Str_1))
                    {
                      p_0 = ATgetArgument(t, 0);
                      t = (ATerm) ATmakeAppl(sym_GuardedLChoice_3, (ATerm)ATmakeAppl(sym_Match_1, (ATerm) ATmakeAppl(sym_Str_1, p_0)), b_1, (ATerm) ATmakeAppl(sym_Case_2, k_1, q_1));
                    }
                  else
                    {
                      if(match_cons(t, sym_Fun_2))
                        ...
                        _fail(t);
                      t = (ATerm) ATmakeAppl(sym_GuardedLChoice_3, (ATerm)ATmakeAppl(sym_Match_1, (ATerm) ATmakeAppl(sym_Op_2, p_0, a_1)), b_1, (ATerm) ATmakeAppl(sym_Case_2, k_1, q_1));
                    }
                }
            }
        }
...
{
  ATerm w_4 = NULL;
  t = SSL_write_term_to_stream_text(u_36, v_36);
  w_4 = t;
...
{
  ATerm z_4 = NULL;
  t = (ATerm) ATmakeAppl(sym__2, f_234, term_g_3);
  t = v_3(t);
  z_4 = t;
  t = (ATerm) ATmakeAppl(sym__2, z_4, a_37);
  t = u_109(t);
  t = fclose_0_0(t);
  t = a_37;
  return(t);
...
{
  ATerm a_5 = NULL;
  t = SSL_write_term_to_stream_baf(q_36, r_36);
  a_5 = t;
...
static ATerm s_3 (ATerm w_36, ATerm t)
{
  t = SSL_read_term_from_stream(w_36);
  return(t);
}
static ATerm t_3 (ATerm t_50, ATerm u_50, ATerm t)
{
  t = SSL_strcat(t_50, u_50);
  return(t);
}
static ATerm u_3 (ATerm r_52, ATerm s_52, ATerm t)
{
  ...
  if(match_cons(t, sym__2))
    {
        ...
        _fail(t);
      {
        ...
        if(((ATgetType(f_5) == AT_LIST) && !(ATisEmpty(f_5))))
          {
            e_8 = ATgetFirst((ATermList) f_5);
            {
              ATerm j_5 = (ATerm) ATgetNext((ATermList) f_5);
            }
          }
        else
          _fail(t);
...
static ATerm h_10 (ATerm m_8, ATerm o_8, ATerm s_8, ATerm t)
{
  ATerm u_8 = NULL,w_8 = NULL,x_8 = NULL,c_9 = NULL,s_1 = NULL;
...
ATerm ReadFromFile_0_0 (ATerm t)
{
  ...
  e_11 = t;
  {
    ...
    if((PushChoice() == 0))
      {
        t = (ATerm) ATmakeAppl(sym__2, e_11, term_c_6);
        t = v_3(t);
        LocalPopChoice(y_5);
      }
    else
...
ATerm map_1_0 (ATerm d_110 (ATerm), ATerm t)
{
  ...
  static ATerm y_12 (ATerm t)
  {
    ...
    if(((ATgetType(t) == AT_LIST) && ATisEmpty(t)))
      ...
      {
        ATerm z_0 = NULL,e_1 = NULL,f_1 = NULL,e_6 = NULL;
        if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
          {
...
static ATerm i_0 (ATerm t)
{
  ATerm v_13 = NULL,y_13 = NULL,z_13 = NULL,q_6 = NULL;
  z_13 = t;
  ...
  if((PushChoice() == 0))
  ...
  else
    {
      t = l_8;
      {
        ...
        if((PushChoice() == 0))
          {
            t = ArgOption_3_0(d_1, g_1, h_1, t);
            LocalPopChoice(q_8);
          }
        else
          {
            t = p_8;
            t = Option_3_0(i_1, j_1, n_1, t);
          }
      }
    }
  return(t);
...
static ATerm e_4 (ATerm n_71, ATerm o_71, ATerm t)
{
  ...
  t = term_n_3;
  x_15 = t;
  t = (ATerm) ATmakeAppl(sym__3, term_n_3, n_71, o_71);
...
static ATerm c_4 (ATerm w_57, ATerm x_57, ATerm v_57, ATerm t)
{
  ...
  w_16 = t;
  t = (ATerm) ATmakeAppl(sym__3, w_57, x_57, (ATerm) ATinsert(CheckATermList(w_16), v_57));
  t = lookup_table_0_1(w_57, t);
  z_16 = t;
  t = (ATerm) ATinsert(CheckATermList(w_16), v_57);
  x_16 = t;
  t = z_16;
  if(match_cons(t, sym_Hashtable_1))
    {
...
static ATerm z_1 (ATerm t)
{
  ...
  t = term_h_6;
  u_17 = t;
  t = (ATerm) ATmakeAppl(sym__2, term_h_6, t_17);
  t = e_4(u_17, t_17, t);
...
static ATerm w_3 (ATerm f_56, ATerm g_56, ATerm t)
{
  ...
  if((PushChoice() == 0))
    {
      t = SSL_addi(f_56, g_56);
      LocalPopChoice(j_9);
    }
  else
    {
      t = i_9;
      t = SSL_addr(f_56, g_56);
    }
  return(t);
}
ATerm foldr_2_0 (ATerm c_117 (ATerm), ATerm d_117 (ATerm), ATerm t)
...
ATerm run_time_0_0 (ATerm t)
{
  ATerm m_18 = NULL,l_1 = NULL,o_1 = NULL;
  t = times_0_0(t);
  o_1 = t;
...
ATerm fetch_1_0 (ATerm n_110 (ATerm), ATerm t)
{
  ...
  static ATerm l_21 (ATerm t)
  {
      ...
      _fail(t);
    {
      ...
      if((PushChoice() == 0))
        {
          ATerm a_4 = NULL,i_4 = NULL,w_6 = NULL;
          t = SSLgetAnnotations(i_21);
          a_4 = t;
          t = j_21;
          t = n_110(t);
          i_4 = t;
          t = (ATerm) ATinsert(CheckATermList(k_21), i_4);
          w_6 = t;
          t = SSLsetAnnotations(w_6, a_4);
          LocalPopChoice(j_10);
        }
      else
        {
          t = g_10;
          {
            ATerm d_5 = NULL,k_5 = NULL,x_6 = NULL;
            t = SSLgetAnnotations(i_21);
            d_5 = t;
            t = k_21;
            t = l_21(t);
            k_5 = t;
            t = (ATerm) ATinsert(CheckATermList(k_5), j_21);
            x_6 = t;
            t = SSLsetAnnotations(x_6, d_5);
          }
        }
    }
    return(t);
      ...
      else
        {
          t = z_10;
          {
            ...
            if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
              ...
              _fail(t);
            t = (ATerm) ATinsert(CheckATermList(w_22), (ATerm) ATmakeAppl(sym_Undefined_1, s_22));
          }
        }
      return(t);
    }
        ...
        x_24 = t;
        {
          ...
          if((PushChoice() == 0))
          ...
          else
            {
              t = t_11;
              {
                ATerm k_6 = NULL,n_6 = NULL,o_6 = NULL;
                t = term_n_3;
                n_6 = t;
                t = term_k_10;
                o_6 = t;
          ...
          if((PushChoice() == 0))
            {
              ...
              t = term_b_9;
              z_24 = t;
              t = (ATerm) ATinsert(ATinsert(ATempty, not_null(c_24)), term_e_12);
              a_25 = t;
              t = SSL_printnl(z_24, a_25);
              t = (ATerm) ATmakeAppl(sym__2, term_b_9, (ATerm) ATinsert(ATinsert(ATempty, not_null(c_24)), term_e_12));
              t = v_130(t);
              t = term_f_9;
              y_24 = t;
              t = SSL_exit(y_24);
...
ATerm option_wrap_5_0 (ATerm x_128 (ATerm), ATerm y_128 (ATerm), ATerm z_128 (ATerm), ATerm a_129 (ATerm), ATerm b_129 (ATerm), ATerm t)
{
  ...
  t = parse_options_3_0(x_128, y_128, z_128, t);
  i_25 = t;
  t = term_f_12;
  t = table_create_0_0(t);
  t = term_f_12;
