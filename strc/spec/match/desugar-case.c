...
static void init_module_constant_terms (void)
{
  ...
  ATprotect(&(term_n_6));
  term_n_6 = (ATerm) ATmakeAppl(sym__2, term_h_6, term_j_6);
  ATprotect(&(term_p_6));
  term_p_6 = (ATerm) ATmakeAppl(sym_Verbose_1, term_j_6);
  ATprotect(&(term_u_6));
  term_u_6 = (ATerm) ATmakeAppl(ATmakeSymbol("-S|--silent      Silent execution (same as --verbose 0)", 0, ATtrue));
  ATprotect(&(term_w_6));
  ...
  ATprotect(&(term_a_7));
  term_a_7 = (ATerm) ATmakeAppl(sym__2, term_y_6, term_w_5);
  ATprotect(&(term_b_7));
  ...
  ATprotect(&(term_p_10));
  term_p_10 = (ATerm) ATmakeAppl(ATmakeSymbol("--about", 0, ATtrue));
  ATprotect(&(term_q_10));
  term_q_10 = (ATerm) ATmakeAppl(sym__2, term_p_10, term_w_5);
  ATprotect(&(term_r_10));
  ...
  ATprotect(&(term_t_10));
  term_t_10 = (ATerm) ATmakeAppl(sym__2, term_s_10, term_w_5);
  ATprotect(&(term_u_10));
  term_u_10 = (ATerm) ATmakeAppl(sym_Version_0);
  ATprotect(&(term_z_10));
  term_z_10 = (ATerm) ATmakeAppl(ATmakeSymbol("--version        Same as --about", 0, ATtrue));
  ATprotect(&(term_h_11));
  term_h_11 = (ATerm) ATmakeAppl(ATmakeSymbol("register-usage-info", 0, ATtrue));
  ATprotect(&(term_p_11));
  term_p_11 = (ATerm) ATmakeAppl(sym__2, term_u_8, term_w_5);
  ATprotect(&(term_q_11));
  ...
  ATprotect(&(term_i_13));
  term_i_13 = (ATerm) ATmakeAppl(sym__2, term_r_4, term_w_5);
  ATprotect(&(term_j_13));
...
ATerm repeat_2_0 (ATerm g_78 (ATerm), ATerm h_78 (ATerm), ATerm t);
ATerm topdown_1_0 (ATerm g_79 (ATerm), ATerm t);
static ATerm k_3 (ATerm g_38, ATerm h_38, ATerm t);
static ATerm l_3 (ATerm p_23, ATerm q_23, ATerm t);
static ATerm n_3 (ATerm j_85 (ATerm), ATerm o_140, ATerm t_23, ATerm t);
static ATerm m_3 (ATerm l_23, ATerm m_23, ATerm t);
static ATerm b_0 (ATerm t);
static ATerm f_0 (ATerm t);
ATerm output_1_0 (ATerm g_103 (ATerm), ATerm t);
static ATerm m_6 (ATerm v_5, ATerm t);
ATerm fclose_0_0 (ATerm t);
static ATerm o_3 (ATerm r_23, ATerm t);
static ATerm p_3 (ATerm i_38, ATerm j_38, ATerm t);
ATerm stdin_stream_0_0 (ATerm t);
ATerm stdout_stream_0_0 (ATerm t);
ATerm stderr_stream_0_0 (ATerm t);
static ATerm j_9 (ATerm e_7, ATerm t);
static ATerm k_9 (ATerm o_7, ATerm p_7, ATerm s_7, ATerm t);
static ATerm m_9 (ATerm c_8, ATerm f_8, ATerm g_8, ATerm t);
static ATerm q_3 (ATerm t);
static ATerm h_0 (ATerm t);
ATerm ReadFromFile_0_0 (ATerm t);
ATerm input_1_0 (ATerm h_103 (ATerm), ATerm t);
...
static ATerm y_3 (ATerm c_47, ATerm d_47, ATerm t);
ATerm Option_3_0 (ATerm c_0 (ATerm), ATerm d_0 (ATerm), ATerm e_0 (ATerm), ATerm t);
static ATerm i_1 (ATerm t);
static ATerm l_1 (ATerm t);
static ATerm m_1 (ATerm t);
ATerm output_option_0_0 (ATerm t);
static ATerm w_3 (ATerm a_52, ATerm b_52, ATerm z_51, ATerm t);
...
static ATerm r_3 (ATerm b_41, ATerm c_41, ATerm t);
ATerm foldr_2_0 (ATerm v_91 (ATerm), ATerm w_91 (ATerm), ATerm t);
...
ATerm fetch_1_0 (ATerm c_86 (ATerm), ATerm t);
ATerm echo_0_0 (ATerm t);
ATerm default_system_about_0_0 (ATerm t);
static ATerm u_3 (ATerm a_37, ATerm b_37, ATerm t);
ATerm debug_1_0 (ATerm h_85 (ATerm), ATerm t);
ATerm map_1_0 (ATerm s_85 (ATerm), ATerm t);
static ATerm d_2 (ATerm t);
static ATerm e_2 (ATerm t);
ATerm eval_config_0_0 (ATerm t);
static ATerm v_3 (ATerm r_53, ATerm s_53, ATerm t);
...
{
  ATerm g_4 = NULL;
  t = (ATerm) ATmakeAppl(sym__2, o_140, term_g_3);
  t = q_3(t);
  g_4 = t;
  t = (ATerm) ATmakeAppl(sym__2, g_4, t_23);
  t = j_85(t);
  t = fclose_0_0(t);
  t = t_23;
  return(t);
...
static ATerm f_0 (ATerm t)
{
  ATerm p_4 = NULL,s_4 = NULL,t_4 = NULL,u_4 = NULL,v_4 = NULL;
  if(match_cons(t, sym__2))
    {
      ATerm t_3 = ATgetArgument(t, 0);
      if(match_cons(t_3, sym_Stream_1))
        {
          u_4 = ATgetArgument(t_3, 0);
        }
      else
        _fail(t);
  ...
  if(match_cons(t, sym_Stream_1))
    ...
    _fail(t);
  t = (ATerm) ATmakeAppl(sym__2, term_x_3, p_4);
  t = k_3(s_4, t_4, t);
  return(t);
}
ATerm output_1_0 (ATerm g_103 (ATerm), ATerm t)
{
  ...
  i_4 = t;
  t = (ATerm) ATmakeAppl(sym__2, i_4, l_4);
  {
    ATerm m_4 = t;
    int q_4 = stack_ptr;
    if((PushChoice() == 0))
...
static ATerm k_9 (ATerm o_7, ATerm p_7, ATerm s_7, ATerm t)
{
  ATerm t_7 = NULL,u_7 = NULL,v_7 = NULL,a_8 = NULL,q_0 = NULL;
  ...
  if(match_cons(t, sym_Path_1))
    ...
    _fail(t);
  t = (ATerm) ATmakeAppl(sym__2, a_8, p_7);
  q_0 = t;
  t = SSLsetAnnotations(q_0, v_7);
  if(match_cons(t, sym__2))
    {
...
static ATerm m_9 (ATerm c_8, ATerm f_8, ATerm g_8, ATerm t)
{
  ATerm h_8 = NULL,j_8 = NULL,q_8 = NULL,x_8 = NULL,r_0 = NULL;
  t = SSLgetAnnotations(g_8);
  q_8 = t;
  t = SSL_is_string(c_8);
  x_8 = t;
  t = (ATerm) ATmakeAppl(sym__2, x_8, f_8);
  r_0 = t;
  t = SSLsetAnnotations(r_0, q_8);
  if(match_cons(t, sym__2))
    {
  ...
  if((PushChoice() == 0))
    {
      ATerm s_9 = NULL;
      s_9 = t;
      t = (ATerm) ATmakeAppl(sym__2, s_9, term_q_5);
      t = q_3(t);
      LocalPopChoice(o_5);
    }
  else
...
ATerm default_usage_0_0 (ATerm t)
{
  ...
  t = term_x_5;
  z_9 = t;
  t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, term_a_6), x_9), term_y_5);
  a_10 = t;
...
static ATerm m_0 (ATerm t)
{
  ...
  e_10 = t;
  t = SSL_string_to_int(e_10);
  g_10 = t;
  t = term_c_6;
  h_10 = t;
  t = (ATerm) ATmakeAppl(sym__2, term_c_6, g_10);
  t = y_3(h_10, g_10, t);
  t = e_10;
  return(t);
}
...
static ATerm z_0 (ATerm t)
{
  ATerm o_10 = NULL,v_10 = NULL,w_10 = NULL;
  o_10 = t;
  t = SSL_string_to_int(o_10);
  v_10 = t;
  t = term_h_6;
  w_10 = t;
  t = (ATerm) ATmakeAppl(sym__2, term_h_6, v_10);
  t = y_3(w_10, v_10, t);
  t = (ATerm) ATmakeAppl(sym_Verbose_1, o_10);
  return(t);
}
static ATerm a_1 (ATerm t)
{
...
static ATerm y_3 (ATerm c_47, ATerm d_47, ATerm t)
{
  ...
  t = term_j_7;
  a_11 = t;
  t = SSL_table_put(a_11, c_47, d_47);
  t = (ATerm) ATmakeAppl(sym__3, term_j_7, c_47, d_47);
  return(t);
}
ATerm Option_3_0 (ATerm c_0 (ATerm), ATerm d_0 (ATerm), ATerm e_0 (ATerm), ATerm t)
{
  ...
  if(match_string(t, "register-usage-info"))
    {
      ATerm j_11 = NULL,l_11 = NULL,n_11 = NULL;
      t = term_w_5;
      t = e_0(t);
      j_11 = t;
      t = term_k_7;
      ...
      t = term_l_7;
      n_11 = t;
      t = (ATerm) ATmakeAppl(sym__3, term_k_7, term_l_7, j_11);
      t = w_3(l_11, n_11, j_11, t);
      _fail(t);
    }
  else
    {
      ...
      t = d_0(t);
      r_11 = t;
      t = (ATerm) ATinsert(CheckATermList(f_11), r_11);
    }
  return(t);
}
static ATerm i_1 (ATerm t)
...
static ATerm l_1 (ATerm t)
{
  ...
  t = term_c_4;
  v_11 = t;
  t = (ATerm) ATmakeAppl(sym__2, term_c_4, u_11);
  t = y_3(v_11, u_11, t);
  t = (ATerm) ATmakeAppl(sym_Output_1, u_11);
  return(t);
}
static ATerm m_1 (ATerm t)
{
...
static ATerm w_3 (ATerm a_52, ATerm b_52, ATerm z_51, ATerm t)
{
  ...
  y_11 = t;
  t = (ATerm) ATinsert(CheckATermList(y_11), z_51);
  z_11 = t;
  t = SSL_table_put(a_52, b_52, z_11);
  t = x_11;
  return(t);
}
ATerm ArgOption_3_0 (ATerm k_0 (ATerm), ATerm l_0 (ATerm), ATerm n_0 (ATerm), ATerm t)
{
  ATerm k_12 = NULL,o_12 = NULL,r_12 = NULL,u_12 = NULL;
  if(match_string(t, "register-usage-info"))
    {
      ...
      t = term_l_7;
      z_12 = t;
      t = (ATerm) ATmakeAppl(sym__3, term_k_7, term_l_7, x_12);
      t = w_3(y_12, z_12, x_12, t);
      _fail(t);
    }
  else
    {
      ...
      t = l_0(t);
      f_13 = t;
      t = (ATerm) ATinsert(CheckATermList(u_12), f_13);
    }
  return(t);
}
static ATerm s_1 (ATerm t)
...
static ATerm t_1 (ATerm t)
{
  ...
  t = term_t_5;
  p_13 = t;
  t = (ATerm) ATmakeAppl(sym__2, term_t_5, o_13);
  t = y_3(p_13, o_13, t);
  t = (ATerm) ATmakeAppl(sym_Input_1, o_13);
  return(t);
}
static ATerm u_1 (ATerm t)
{
...
ATerm report_failure_0_0 (ATerm t)
{
  ...
  t = term_x_5;
  s_13 = t;
  t = (ATerm) ATinsert(ATinsert(ATempty, term_y_7), q_13);
  t_13 = t;
  ...
  if(((ATgetType(t) == AT_LIST) && ATisEmpty(t)))
  ...
  else
    {
      ...
      if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
        ...
        _fail(t);
      t = x_13;
      t = foldr_2_0(v_91, w_91, t);
      a_14 = t;
      t = (ATerm) ATmakeAppl(sym__2, w_13, a_14);
      t = w_91(t);
    }
  return(t);
}
...
ATerm run_time_0_0 (ATerm t)
{
  ATerm d_14 = NULL,o_0 = NULL,p_0 = NULL;
  t = times_0_0(t);
  p_0 = t;
    ...
    if((PushChoice() == 0))
      {
        ...
        t = get_config_0_0(t);
        y_14 = t;
        t = (ATerm) ATmakeAppl(sym__2, y_14, term_b_6);
        t = geq_0_0(t);
        t = w_14;
        t = h_100(t);
        LocalPopChoice(o_8);
...
static ATerm x_1 (ATerm t)
{
  ATerm a_15 = NULL,b_15 = NULL,d_15 = NULL,e_15 = NULL;
  t = run_time_0_0(t);
  a_15 = t;
  t = term_w_5;
  t = whoami_0_0(t);
  ...
  t = term_x_5;
  d_15 = t;
  t = (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATempty, term_r_8), a_15), term_p_8), b_15);
  e_15 = t;
  t = SSL_printnl(d_15, e_15);
  t = (ATerm) ATmakeAppl(sym__2, term_x_5, (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATempty, term_r_8), a_15), term_p_8), b_15));
  return(t);
}
ATerm report_run_time_0_0 (ATerm t)
{
      ...
      if(match_cons(t, sym_Undefined_1))
        {
          ...
          {
            ATerm p_1 = NULL,p_5 = NULL;
            t = SSLgetAnnotations(o_15);
            p_1 = t;
            t = (ATerm) ATmakeAppl(sym_Undefined_1, n_15);
            p_5 = t;
            t = SSLsetAnnotations(p_5, p_1);
          }
        }
      else
        {
  ...
  if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
    {
      ...
      s_15 = (ATerm) ATgetNext((ATermList) t);
      {
        ...
        {
          t = (ATerm) ATinsert(CheckATermList(not_null(w_15)), not_null(x_15));
          return(t);
        }
        t = s_15;
        t = i_0(t);
...
static ATerm a_2 (ATerm t)
{
  ATerm b_16 = NULL,c_16 = NULL,d_16 = NULL,i_6 = NULL;
  d_16 = t;
  ...
  b_16 = t;
  t = (ATerm) ATmakeAppl(sym_Program_1, c_16);
  i_6 = t;
  t = SSLsetAnnotations(i_6, b_16);
  return(t);
}
static ATerm b_2 (ATerm t)
{
...
static ATerm c_2 (ATerm t)
{
  ATerm f_16 = NULL;
  f_16 = t;
  t = (ATerm) ATinsert(ATinsert(ATempty, f_16), term_v_8);
  t = echo_0_0(t);
  return(t);
}
ATerm default_system_usage_0_0 (ATerm t)
...
ATerm fetch_1_0 (ATerm c_86 (ATerm), ATerm t)
{
  static ATerm c_17 (ATerm t)
  {
      ...
      _fail(t);
    {
      ...
      if((PushChoice() == 0))
        {
          ATerm t_2 = NULL,a_3 = NULL,k_6 = NULL;
          t = SSLgetAnnotations(z_16);
          t_2 = t;
          t = a_17;
          t = c_86(t);
          a_3 = t;
          t = (ATerm) ATinsert(CheckATermList(b_17), a_3);
          k_6 = t;
          t = SSLsetAnnotations(k_6, t_2);
          LocalPopChoice(c_9);
        }
      else
        {
          t = b_9;
          {
            ...
            t = c_17(t);
            k_4 = t;
            t = (ATerm) ATinsert(CheckATermList(k_4), a_17);
            l_6 = t;
...
ATerm debug_1_0 (ATerm h_85 (ATerm), ATerm t)
{
  ...
  t = term_x_5;
  o_17 = t;
  t = (ATerm) ATinsert(ATinsert(ATempty, m_17), n_17);
  p_17 = t;
...
ATerm get_config_0_0 (ATerm t)
{
  ...
  t = term_j_7;
  e_19 = t;
  t = (ATerm) ATmakeAppl(sym__2, term_j_7, d_19);
  t = v_3(e_19, d_19, t);
  {
    ATerm j_10 = t;
    int l_10 = stack_ptr;
...
ATerm Cons_2_0 (ATerm f_65 (ATerm), ATerm g_65 (ATerm), ATerm t)
{
  ATerm p_19 = NULL,q_19 = NULL,r_19 = NULL,s_19 = NULL,t_19 = NULL,u_19 = NULL,v_6 = NULL;
  u_19 = t;
  if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
    {
  ...
  v_6 = t;
  t = SSLsetAnnotations(v_6, p_19);
  return(t);
}
ATerm parse_options_p__1_0 (ATerm a_105 (ATerm), ATerm t)
{
  ATerm z_19 = NULL,a_20 = NULL,b_20 = NULL,c_20 = NULL,e_20 = NULL,f_20 = NULL,x_6 = NULL;
  z_19 = t;
  {
    ATerm e_11 = t;
    int g_11 = stack_ptr;
  ...
  t = term_z_7;
  f_20 = t;
  t = (ATerm) ATmakeAppl(sym__2, term_z_7, b_20);
  t = y_3(f_20, b_20, t);
  t = c_20;
  {
      ...
      else
        {
          t = i_11;
          {
            ...
            if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
              ...
              _fail(t);
            t = (ATerm) ATinsert(CheckATermList(m_20), (ATerm) ATmakeAppl(sym_Undefined_1, l_20));
          }
        }
      return(t);
    }
  ...
  e_20 = t;
  t = (ATerm) ATinsert(CheckATermList(e_20), (ATerm) ATmakeAppl(sym_Program_1, b_20));
  x_6 = t;
  t = SSLsetAnnotations(x_6, a_20);
  return(t);
}
static ATerm m_2 (ATerm t)
{
...
ATerm parse_options_1_0 (ATerm z_104 (ATerm), ATerm t)
{
  ATerm u_20 = NULL,v_20 = NULL,z_20 = NULL,h_21 = NULL,n_21 = NULL,s_21 = NULL,x_21 = NULL;
  z_20 = t;
  t = term_k_7;
  n_21 = t;
  t = term_l_7;
          ...
          if((PushChoice() == 0))
            {
              ...
              t = term_x_5;
              n_22 = t;
              t = (ATerm) ATinsert(ATinsert(ATempty, not_null(u_20)), term_m_12);
              o_22 = t;
              t = SSL_printnl(n_22, o_22);
              t = (ATerm) ATmakeAppl(sym__2, term_x_5, (ATerm) ATinsert(ATinsert(ATempty, not_null(u_20)), term_m_12));
              t = default_system_usage_0_0(t);
              t = term_b_6;
              m_22 = t;
              t = SSL_exit(m_22);
