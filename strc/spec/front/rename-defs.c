...
void init_constant_terms (void)
{
  ...
  ATprotect(&(term_w_8));
  term_w_8 = (ATerm) ATmakeAppl(ATmakeSymbol("m_0", 0, ATtrue));
  ATprotect(&(term_c_9));
  term_c_9 = (ATerm) ATmakeAppl(ATmakeSymbol("b_0", 0, ATtrue));
  ATprotect(&(term_g_9));
...
ATerm default_usage_0_0 (ATerm t)
{
  ...
  t = term_p_6;
  o_0 = t;
  t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, term_r_6), c_0), term_q_6);
  s_0 = t;
  ...
  if(match_cons(t, sym_Defined_2))
    {
      ...
      if((ATgetSymbol((ATermAppl) v_6) != ATmakeSymbol("b_0", 0, ATtrue)))
        _fail(t);
              ...
              if(match_cons(t, sym_Defined_2))
                {
                  ...
                  if((ATgetSymbol((ATermAppl) c_8) != ATmakeSymbol("m_0", 0, ATtrue)))
                    _fail(t);
