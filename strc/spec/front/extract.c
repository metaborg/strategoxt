...
ATerm w_9 (ATerm o_33, ATerm p_33, ATerm);
          ...
          if(match_cons(t, sym_Defined_2))
            {
              ...
              if((ATgetSymbol((ATermAppl) c_31) != ATmakeSymbol("m_0", 0, ATtrue)))
                _fail(t);
...
ATerm w_9 (ATerm o_33, ATerm p_33, ATerm t)
{
  ATerm n_36 = t;
  int p_36 = stack_ptr;
  if((PushChoice() == 0))
    {
      t = SSL_addi(o_33, p_33);
      ;
      LocalPopChoice(p_36);
    }
  else
