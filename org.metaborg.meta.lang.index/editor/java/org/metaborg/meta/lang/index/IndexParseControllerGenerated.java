...
public class IndexParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Index");
  ...
  { 
    IndexParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = IndexParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = IndexParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(IndexParseControllerGenerated.class);
    }
  ...
  { 
    return IndexParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
