...
ATerm list_1 (ATerm, ATerm z_65 (ATerm));
...
ATerm at_tail_1 (ATerm, ATerm k_66 (ATerm));
...
ATerm list_1 (ATerm t, ATerm z_65 (ATerm))
{
  ATerm b_10 (ATerm t)
  {
    ATerm t_3 = t;
...
ATerm at_tail_1 (ATerm t, ATerm k_66 (ATerm))
{
  t = Cons_2(t, _id, k_66);
  return(t);
}
