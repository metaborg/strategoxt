...
static ATerm u_1 (ATerm d_12, ATerm e_12, ATerm f_12, ATerm t)
{
  t = (ATerm) ATmakeAppl(sym_appl_2, (ATerm)ATmakeAppl(sym_prod_3, (ATerm)ATinsert(ATempty, (ATerm) ATmakeAppl(sym_lex_1, d_12)), (ATerm)ATmakeAppl(sym_cf_1, d_12), term_y_0), (ATerm) ATmakeAppl(sym_appl_2, (ATerm)ATmakeAppl(sym_prod_3, (ATerm)ATinsert(ATempty, (ATerm) ATmakeAppl(sym_lex_1, (ATerm) ATmakeAppl(sym_iter_star_1, (ATerm) ATmakeAppl(sym_char_class_1, (ATerm) ATinsert(ATempty, term_b_1))))), (ATerm)ATmakeAppl(sym_lex_1, d_12), term_y_0), (ATerm) ATinsert(ATempty, (ATerm) ATmakeAppl(sym_appl_2, (ATerm)ATmakeAppl(sym_prod_3, e_12, (ATerm)ATmakeAppl(sym_lex_1, (ATerm) ATmakeAppl(sym_iter_star_1, (ATerm) ATmakeAppl(sym_char_class_1, (ATerm) ATinsert(ATempty, term_b_1)))), term_y_0), f_12))));
  return(t);
}
ATerm unflatten_lexical_0_0 (ATerm t)
{
  ...
  l_0 = t;
  {
    ...
    if((PushChoice() == 0))
    ...
    else
      {
        t = h_2;
        {
          ATerm m_0 = NULL,q_0 = NULL,r_0 = NULL;
          ATerm s_2 = t;
          int t_2 = stack_ptr;
          if((PushChoice() == 0))
            {
...
static ATerm o_0 (ATerm t)
{
  ATerm q_7 = NULL;
  q_7 = t;
  t = (ATerm) ATmakeAppl(sym_char_class_1, (ATerm) ATinsert(ATempty, q_7));
  return(t);
}
static ATerm w_1 (ATerm c_0, ATerm e_0, ATerm t)
{
