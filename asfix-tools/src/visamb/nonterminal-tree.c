...
static ATerm s_1 (ATerm c_0, ATerm i_0, ATerm e_0, ATerm t);
...
ATerm De_Escape_0_0 (ATerm t)
{
  ATerm m_0 = NULL,n_0 = NULL,p_0 = NULL,q_0 = NULL;
  if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
    {
      ...
      if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
          ...
          if(match_int(t, 34))
            {
              ...
              if(match_int(t, 92))
                  ...
                  if((PushChoice() == 0))
                  ...
                  else
                    {
                      t = o_0;
                      {
                        ...
                        t = De_Escape_0_0(t);
                        w_0 = t;
                        t = (ATerm) ATinsert(CheckATermList(w_0), p_0);
                      }
                    }
                }
              else
                {
                  ...
                  t = De_Escape_0_0(t);
                  a_1 = t;
                  t = (ATerm) ATinsert(CheckATermList(a_1), p_0);
                }
            }
          else
            {
              if(match_int(t, 92))
                {
                  ...
                  if(match_int(t, 92))
                      ...
                      if((PushChoice() == 0))
                        {
                          ...
                          t = De_Escape_0_0(t);
                          c_1 = t;
                          t = (ATerm) ATinsert(CheckATermList(c_1), term_x_0);
                          LocalPopChoice(v_0);
                        }
                      else
                        {
                          t = u_0;
                          {
                            ...
                            t = De_Escape_0_0(t);
                            f_1 = t;
                            t = (ATerm) ATinsert(CheckATermList(f_1), p_0);
                          }
                        }
                    }
                  else
                    {
                      ...
                      t = De_Escape_0_0(t);
                      i_1 = t;
                      t = (ATerm) ATinsert(CheckATermList(i_1), p_0);
                    }
                }
              else
                {
                  ...
                  t = De_Escape_0_0(t);
                  l_1 = t;
                  t = (ATerm) ATinsert(CheckATermList(l_1), p_0);
                }
            }
        }
      else
        {
          ...
          t = De_Escape_0_0(t);
          o_1 = t;
          t = (ATerm) ATinsert(CheckATermList(o_1), p_0);
        }
    }
  else
    {
  ...
  if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
    {
      ...
      if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
          ...
          if(match_int(t, 34))
            {
              ...
              if(match_int(t, 92))
                  ...
                  if((PushChoice() == 0))
                    {
                      ...
                      t = De_Escape_0_0(t);
                      d_2 = t;
                      t = (ATerm) ATinsert(CheckATermList(d_2), term_s_0);
                      LocalPopChoice(z_0);
                    }
                  else
                    {
                      t = y_0;
                      {
                        ...
                        t = De_Escape_0_0(t);
                        h_2 = t;
                        t = (ATerm) ATinsert(CheckATermList(h_2), z_1);
                      }
                    }
                }
              else
                {
                  ...
                  t = De_Escape_0_0(t);
                  k_2 = t;
                  t = (ATerm) ATinsert(CheckATermList(k_2), z_1);
                }
            }
          else
            {
              if(match_int(t, 92))
                {
                  ...
                  if(match_int(t, 92))
                      ...
                      if((PushChoice() == 0))
                        {
                          ...
                          t = De_Escape_0_0(t);
                          m_2 = t;
                          t = (ATerm) ATinsert(CheckATermList(m_2), term_x_0);
                          LocalPopChoice(d_1);
                        }
                      else
                        {
                          t = b_1;
                          {
                            ...
                            t = De_Escape_0_0(t);
                            p_2 = t;
                            t = (ATerm) ATinsert(CheckATermList(p_2), z_1);
                          }
                        }
                    }
                  else
                    {
                      ...
                      t = De_Escape_0_0(t);
                      s_2 = t;
                      t = (ATerm) ATinsert(CheckATermList(s_2), z_1);
                    }
                }
              else
                {
                  ...
                  t = De_Escape_0_0(t);
                  v_2 = t;
                  t = (ATerm) ATinsert(CheckATermList(v_2), z_1);
                }
            }
        }
      else
        {
          ...
          t = De_Escape_0_0(t);
          y_2 = t;
          t = (ATerm) ATinsert(CheckATermList(y_2), z_1);
        }
    }
  else
    {
  ...
  if(((ATgetType(t) == AT_LIST) && !(ATisEmpty(t))))
    {
      ...
      if(((ATgetType(e_1) != AT_INT) || (ATgetInt((ATermInt) e_1) != 34)))
        _fail(t);
      {
        ATerm g_1 = (ATerm) ATgetNext((ATermList) t);
      ...
      if(match_cons(t, sym_lex_1))
      ...
      else
        {
          if(match_cons(t, sym_empty_0))
            {
              t = (ATerm) ATinsert(ATempty, term_m_1);
            }
          else
            {
                              ...
                              if(match_cons(t, sym_iter_sep_2))
                                {
                                  ...
                                  d_3 = ATgetArgument(t, 1);
                                  {
                                    ...
                                    t = Sym2Strs_0_0(t);
                                    p_3 = t;
                                    t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, (ATerm) ATinsert(ATempty, term_j_1)), p_3), o_3);
                                    t = concat_0_0(t);
                                  }
                                }
                              else
                                                    ...
                                                    if(match_cons(t, sym_func_2))
                                                      {
                                                        ...
                                                        d_3 = ATgetArgument(t, 1);
                                                        {
                                                          ...
                                                          t = Sym2Strs_0_0(t);
                                                          i_4 = t;
                                                          t = (ATerm) ATinsert(ATinsert(ATinsert(ATempty, i_4), (ATerm) ATinsert(ATempty, term_b_2)), h_4);
                                                          t = concat_0_0(t);
                                                        }
                                                      }
                                                    else
