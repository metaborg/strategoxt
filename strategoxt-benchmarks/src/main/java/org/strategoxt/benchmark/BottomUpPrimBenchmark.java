...
public class BottomUpPrimBenchmark extends TreeTraversalBenchmark {
    ...
    public Function<IStrategoTerm, IStrategoTerm> createBenchmark() {
        ...
        return currentTerm ->
                SRTS_EXT_downup_2_0.instance.invoke(context, currentTerm, org.strategoxt.lang._Id.instance, program);
    }
}
