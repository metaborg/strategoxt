...
static void init_module_constant_terms (void)
{
  ...
  ATprotect(&(term_n_0));
  term_n_0 = (ATerm) ATmakeAppl(ATmakeSymbol("fail", 0, ATtrue));
  ATprotect(&(term_p_0));
...
ATerm iowrap_1_0 (ATerm q_113 (ATerm), ATerm t);
