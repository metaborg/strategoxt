...
ATerm xtc_iowrap_1 (ATerm, ATerm o_70 (ATerm));
...
ATerm xtc_iowrap_1 (ATerm t, ATerm o_70 (ATerm))
{
  t = xtc_io_wrap_2(t, _fail, o_70);
  return(t);
}
ATerm astratego2text_0 (ATerm t)
{
  ATerm c_5 (ATerm t)
  {
    ...
    ATerm e_5 (ATerm t)
    {
      ...
      t = (ATerm) ATinsert(ATinsert(ATempty, not_null(z_43)), term_w_24);
      return(t);
    }
