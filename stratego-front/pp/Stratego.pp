[
   SDefNoArgs                       -- _1 KW["="] _2,
   SDefS                            -- _1 KW["("] _2 KW[")"] KW["="] _3,
   SDefS.2:iter-star-sep            -- _1 KW[","],
   SDef                             -- _1 KW["("] _2 KW["|"] _3 KW[")"] KW["="] _4,
   SDef.2:iter-star-sep             -- _1 KW[","],
   SDef.3:iter-star-sep             -- _1 KW[","],
   DefaultVarDec                    -- _1,
   VarDec                           -- _1 KW[":"] _2,
   ParenStrat                       -- KW["("] _1 KW[")"],
   Fail                             -- KW["fail"],
   ...
   Prim                             -- KW["prim"] KW["("] _1 KW[","] _2 KW["|"] _3 KW[")"],
   Prim.2:iter-star-sep             -- _1 KW[","],
   Prim.3:iter-star-sep             -- _1 KW[","],
   Path                             -- _1 _2,
   ...
   RDef                             -- _1 KW["("] _2 KW["|"] _3 KW[")"] KW[":"] _4,
   RDef.2:iter-star-sep             -- _1 KW[","],
   RDef.3:iter-star-sep             -- _1 KW[","],
   SRDefNoArgs                      -- _1 KW["::"] _2,
   SRDef                            -- _1 KW["("] _2 KW[")"] KW["::"] _3,
   SRDef.2:iter-star-sep            -- _1 KW[","],
   SRDef                            -- _1 KW["("] _2 KW["|"] _3 KW[")"] KW["::"] _4,
   SRDef.2:iter-star-sep            -- _1 KW[","],
   SRDef.3:iter-star-sep            -- _1 KW[","],
   RuleNoCond                       -- _1 KW["->"] _2,
