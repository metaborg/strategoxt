[
   ...
   --saved-entry--SwitchChoiceNoOtherwise.2:iter-star -- V is=2 vs=0 [H hs=1 [KW["case"] _1 KW[":"]] _2],
   --saved-entry--BA                                  -- H hs=1 [H hs=0 [KW["<"] _1 KW[">"]] _2],
   --saved-entry--Con4                                -- KW["["] _1 KW["where"] _2 KW["]"] KW["("] _3 KW[")"],
   --saved-entry--Con3                                -- KW["["] _1 KW["where"] _2 KW["]"],
   --saved-entry--Con1                                -- H hs=0 [KW["["] _1 KW["]"]],
   --saved-entry--Anno                                -- _1 KW["{"] _2 KW["}"],
   --saved-entry--RootApp                             -- H hs=0 [KW["<"] _1 KW[">"]],
   --saved-entry--OpDeclInj                           -- R  ["" KW[":"] H hs=1 [_1]],
